...
//	import static com.opengamma.strata.measure.StandardComponents.marketDataFactory;
	...
	public class CalibrationEur3CheckExample
	{
	  ...
	  /// The valuation date.
	  /// </summary>
	  private static readonly LocalDate VAL_DATE = LocalDate.of(2015, 11, 20);
	  ...
	  /// </summary>
	  private static readonly CurveGroupName CURVE_GROUP_NAME = CurveGroupName.of("EUR-DSCONOIS-EURIBOR3MBS-EURIBOR6MIRS");
	  ...
	  /// </summary>
	  private static readonly ResourceLocator GROUPS_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/groups-eur.csv"));
	  /// <summary>
	  /// The location of the curve calibration settings file.
	  /// </summary>
	  private static readonly ResourceLocator SETTINGS_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/settings-eur.csv"));
	  /// <summary>
	  /// The location of the curve calibration nodes file.
	  /// </summary>
	  private static readonly ResourceLocator CALIBRATION_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/calibrations-eur.csv"));
	  /// <summary>
	  /// The location of the market quotes file.
	  /// </summary>
	  private static readonly ResourceLocator QUOTES_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "quotes/quotes-eur.csv"));
