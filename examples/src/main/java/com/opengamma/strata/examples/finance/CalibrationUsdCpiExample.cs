...
//	import static com.opengamma.strata.measure.StandardComponents.marketDataFactory;
	...
	/// The other curve is used for price index/CPI forward.
	/// </para>
	/// <para>
	...
	/// </para>
	/// </summary>
	public class CalibrationUsdCpiExample
	{
	  ...
	  /// </summary>
	  private static readonly CurveGroupName CURVE_GROUP_NAME = CurveGroupName.of("USD-DSCON-CPI");
	  ...
	  /// </summary>
	  private static readonly ResourceLocator SETTINGS_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/settings-usd-cpi.csv"));
	  /// <summary>
	  /// The location of the curve calibration nodes file.
	  /// </summary>
	  private static readonly ResourceLocator CALIBRATION_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/calibrations-cpi.csv"));
	  /// <summary>
	  ...
	  /// </summary>
	  private static readonly ResourceLocator FIXING_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "fixings/us-cpi-u.csv"));
	  ...
	  public static void Main(string[] args)
	  {
		...
		// check that all trades have a PV near 0
