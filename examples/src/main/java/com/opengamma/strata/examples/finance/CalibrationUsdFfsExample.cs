...
//	import static com.opengamma.strata.measure.StandardComponents.marketDataFactory;
	...
	/// The calibration is done using Fed Funds Swaps (Fed Fund v Libor 3M).
	/// </para>
	/// <para>
	...
	/// </para>
	/// </summary>
	public class CalibrationUsdFfsExample
	{
	  ...
	  /// </summary>
	  private static readonly ResourceLocator SETTINGS_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/settings.csv"));
	  /// <summary>
	  /// The location of the curve calibration nodes file.
	  /// </summary>
	  private static readonly ResourceLocator CALIBRATION_RESOURCE = ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/calibrations-ffs.csv"));
	  /// <summary>
