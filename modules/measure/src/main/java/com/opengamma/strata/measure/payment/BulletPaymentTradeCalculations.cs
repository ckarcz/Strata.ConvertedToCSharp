...
namespace com.opengamma.strata.measure.payment
{
	...
	/// </para>
	/// <para>
	/// Each method takes a <seealso cref="ResolvedBulletPaymentTrade"/>, whereas application code will
	/// typically work with <seealso cref="BulletPaymentTrade"/>. Call
	/// <seealso cref="BulletPaymentTrade#resolve(com.opengamma.strata.basics.ReferenceData) BulletPaymentTrade::resolve(ReferenceData)"/>
	...
	public class BulletPaymentTradeCalculations
	{
	  ...
	  /// </summary>
	  public static readonly BulletPaymentTradeCalculations DEFAULT = new BulletPaymentTradeCalculations(DiscountingBulletPaymentTradePricer.DEFAULT);

	  /// <summary>
	  /// Pricer for <seealso cref="ResolvedBulletPaymentTrade"/>.
	  /// </summary>
	  private readonly BulletPaymentMeasureCalculations calc;
	  ...
	  public virtual MultiCurrencyAmount pv01CalibratedSum(ResolvedBulletPaymentTrade trade, RatesProvider ratesProvider)
	  {
	  ...
	  /// <param name="marketData">  the market data </param>
	  /// <returns> the present value sensitivity, one entry per scenario </returns>
	  public virtual ScenarioArray<CurrencyParameterSensitivities> pv01CalibratedBucketed(ResolvedBulletPaymentTrade trade, RatesMarketDataLookup lookup, ScenarioMarketData marketData)
	  {
	  ...
	  /// <param name="ratesProvider">  the market data </param>
	  /// <returns> the present value sensitivity </returns>
	  public virtual CurrencyParameterSensitivities pv01CalibratedBucketed(ResolvedBulletPaymentTrade trade, RatesProvider ratesProvider)
	  {
	  ...
	  /// <param name="marketData">  the market data </param>
	  /// <returns> the present value sensitivity, one entry per scenario </returns>
	  public virtual MultiCurrencyScenarioArray pv01MarketQuoteSum(ResolvedBulletPaymentTrade trade, RatesMarketDataLookup lookup, ScenarioMarketData marketData)
	  {
	  ...
	  public virtual CurrencyScenarioArray currentCash(ResolvedBulletPaymentTrade trade, RatesMarketDataLookup lookup, ScenarioMarketData marketData)
	  {
