...
namespace com.opengamma.strata.measure.credit
{
	...
	/// </para>
	/// </summary>
	internal sealed class CdsIndexMeasureCalculations
	{

	  /// <summary>
	  /// Default implementation.
	  /// </summary>
	  public static readonly CdsIndexMeasureCalculations DEFAULT = new CdsIndexMeasureCalculations(new IsdaHomogenousCdsIndexTradePricer(AccrualOnDefaultFormula.CORRECT));
	  ...
	  /// <summary>
	  /// Pricer for <seealso cref="ResolvedCdsIndexTrade"/>.
	  /// </summary>
	  private readonly IsdaHomogenousCdsIndexTradePricer tradePricer;
	  /// <summary>
	  ...
	  internal CurrencyScenarioArray ir01CalibratedParallel(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal ScenarioArray<CurrencyParameterSensitivity> ir01CalibratedBucketed(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal MultiCurrencyScenarioArray ir01MarketQuoteParallel(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal ScenarioArray<CurrencyParameterSensitivities> ir01MarketQuoteBucketed(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal CurrencyParameterSensitivities ir01MarketQuoteBucketed(ResolvedCdsIndexTrade trade, CreditRatesProvider ratesProvider, ReferenceData refData)
	  {
	  ...
	  internal MultiCurrencyScenarioArray pv01CalibratedSum(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal MultiCurrencyAmount pv01CalibratedSum(ResolvedCdsIndexTrade trade, CreditRatesProvider ratesProvider, ReferenceData refData)
	  {
	  ...
	  internal ScenarioArray<CurrencyParameterSensitivities> pv01CalibratedBucketed(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal ScenarioArray<CurrencyParameterSensitivities> pv01MarketQuoteBucketed(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal CurrencyScenarioArray cs01Parallel(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal CurrencyScenarioArray recovery01(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
	  ...
	  internal CurrencyScenarioArray expectedLoss(ResolvedCdsIndexTrade trade, CreditRatesScenarioMarketData marketData, ReferenceData refData)
	  {
