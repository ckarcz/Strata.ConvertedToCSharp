...
namespace com.opengamma.strata.measure.fx
{
	...
	/// </para>
	/// </summary>
	internal sealed class FxNdfMeasureCalculations
	{

	  /// <summary>
	  /// Default implementation.
	  /// </summary>
	  public static readonly FxNdfMeasureCalculations DEFAULT = new FxNdfMeasureCalculations(DiscountingFxNdfTradePricer.DEFAULT);
	  /// <summary>
	  ...
	  /// </summary>
	  private readonly DiscountingFxNdfTradePricer tradePricer;

	  /// <summary>
	  /// Creates an instance.
	  /// </summary>
	  /// <param name="tradePricer">  the pricer for <seealso cref="ResolvedFxNdfTrade"/> </param>
	  internal FxNdfMeasureCalculations(DiscountingFxNdfTradePricer tradePricer)
	  {
	  ...
	  internal MultiCurrencyAmount pv01CalibratedSum(ResolvedFxNdfTrade trade, RatesProvider ratesProvider)
	  {
	  ...
	  internal MultiCurrencyScenarioArray pv01MarketQuoteSum(ResolvedFxNdfTrade trade, RatesScenarioMarketData marketData)
	  {
	  ...
	  internal MultiCurrencyAmount pv01MarketQuoteSum(ResolvedFxNdfTrade trade, RatesProvider ratesProvider)
	  {
	  ...
	  internal ScenarioArray<CurrencyParameterSensitivities> pv01MarketQuoteBucketed(ResolvedFxNdfTrade trade, RatesScenarioMarketData marketData)
	  {
	  ...
	  internal CurrencyScenarioArray currentCash(ResolvedFxNdfTrade trade, RatesScenarioMarketData marketData)
	  {
