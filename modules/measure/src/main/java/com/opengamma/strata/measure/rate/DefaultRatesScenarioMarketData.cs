...
namespace com.opengamma.strata.measure.rate
{
	...
	/// <para>
	/// This uses a <seealso cref="RatesMarketDataLookup"/> to provide a view on <seealso cref="ScenarioMarketData"/>.
	/// </para>
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @BeanDefinition(style = "light") final class DefaultRatesScenarioMarketData implements RatesScenarioMarketData, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	internal sealed class DefaultRatesScenarioMarketData : RatesScenarioMarketData, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableConstructor private DefaultRatesScenarioMarketData(RatesMarketDataLookup lookup, com.opengamma.strata.data.scenario.ScenarioMarketData marketData)
	  ...
	  /// </summary>
	  private static readonly TypedMetaBean<DefaultRatesScenarioMarketData> META_BEAN = LightMetaBean.of(typeof(DefaultRatesScenarioMarketData), MethodHandles.lookup(), new string[] {"lookup", "marketData"}, new object[0]);

	  /// <summary>
	  /// The meta-bean for {@code DefaultRatesScenarioMarketData}. </summary>
	  ...
	  static DefaultRatesScenarioMarketData()
	  {
	  ...
	  public override TypedMetaBean<DefaultRatesScenarioMarketData> metaBean()
	  {
		return META_BEAN;
	  }
