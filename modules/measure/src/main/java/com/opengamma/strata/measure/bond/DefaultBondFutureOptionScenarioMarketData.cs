...
namespace com.opengamma.strata.measure.bond
{
	...
	/// <para>
	/// This uses a <seealso cref="BondFutureOptionMarketDataLookup"/> to provide a view on <seealso cref="ScenarioMarketData"/>.
	/// </para>
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @BeanDefinition(style = "light") final class DefaultBondFutureOptionScenarioMarketData implements BondFutureOptionScenarioMarketData, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	internal sealed class DefaultBondFutureOptionScenarioMarketData : BondFutureOptionScenarioMarketData, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.data.scenario.ScenarioMarketData marketData;
	  ...
	  /// </summary>
	  [NonSerialized]
	  private readonly AtomicReferenceArray<BondFutureOptionMarketData> cache; // derived
	  ...
	  public static DefaultBondFutureOptionScenarioMarketData of(BondFutureOptionMarketDataLookup lookup, ScenarioMarketData marketData)
	  {
...
//ORIGINAL LINE: @ImmutableConstructor private DefaultBondFutureOptionScenarioMarketData(BondFutureOptionMarketDataLookup lookup, com.opengamma.strata.data.scenario.ScenarioMarketData marketData)
	  ...
	  /// </summary>
	  private static readonly TypedMetaBean<DefaultBondFutureOptionScenarioMarketData> META_BEAN = LightMetaBean.of(typeof(DefaultBondFutureOptionScenarioMarketData), MethodHandles.lookup(), new string[] {"lookup", "marketData"}, new object[0]);

	  /// <summary>
	  /// The meta-bean for {@code DefaultBondFutureOptionScenarioMarketData}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static TypedMetaBean<DefaultBondFutureOptionScenarioMarketData> meta()
	  {
		return META_BEAN;
	  }

	  static DefaultBondFutureOptionScenarioMarketData()
	  {
	  ...
	  public override TypedMetaBean<DefaultBondFutureOptionScenarioMarketData> metaBean()
	  {
		return META_BEAN;
	  }
