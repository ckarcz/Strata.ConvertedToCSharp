...
namespace com.opengamma.strata.measure.bond
{
	...
	/// </para>
	/// <para>
	/// Each method takes a <seealso cref="ResolvedFixedCouponBondTrade"/>, whereas application code will
	/// typically work with <seealso cref="FixedCouponBondTrade"/>. Call
	/// <seealso cref="FixedCouponBondTrade#resolve(com.opengamma.strata.basics.ReferenceData) FixedCouponBondTrade::resolve(ReferenceData)"/>
	...
	public class FixedCouponBondTradeCalculations
	{
	  ...
	  /// </summary>
	  public static readonly FixedCouponBondTradeCalculations DEFAULT = new FixedCouponBondTradeCalculations(DiscountingFixedCouponBondTradePricer.DEFAULT);

	  /// <summary>
	  /// Pricer for <seealso cref="ResolvedFixedCouponBondTrade"/>.
	  /// </summary>
	  private readonly FixedCouponBondMeasureCalculations calc;
	  ...
	  public virtual MultiCurrencyAmount pv01CalibratedSum(ResolvedFixedCouponBondTrade trade, LegalEntityDiscountingProvider ratesProvider)
	  {
	  ...
	  /// <param name="ratesProvider">  the market data </param>
	  /// <returns> the present value sensitivity </returns>
	  public virtual CurrencyParameterSensitivities pv01CalibratedBucketed(ResolvedFixedCouponBondTrade trade, LegalEntityDiscountingProvider ratesProvider)
	  {
	  ...
	  /// <param name="marketData">  the market data </param>
	  /// <returns> the present value sensitivity, one entry per scenario </returns>
	  public virtual MultiCurrencyScenarioArray pv01MarketQuoteSum(ResolvedFixedCouponBondTrade trade, LegalEntityDiscountingMarketDataLookup lookup, ScenarioMarketData marketData)
	  {
	  ...
	  public virtual MultiCurrencyAmount currencyExposure(ResolvedFixedCouponBondTrade trade, LegalEntityDiscountingProvider ratesProvider)
	  {
