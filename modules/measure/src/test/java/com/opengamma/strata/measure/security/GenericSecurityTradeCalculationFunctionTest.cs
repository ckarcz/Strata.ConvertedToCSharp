...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	/// <summary>
	/// Test <seealso cref="GenericSecurityTradeCalculationFunction"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class GenericSecurityTradeCalculationFunctionTest
	public class GenericSecurityTradeCalculationFunctionTest
	{
	  ...
	  public static readonly GenericSecurityTrade TRADE = GenericSecurityTrade.builder().info(TradeInfo.builder().settlementDate(LocalDate.of(2013, 12, 15)).build()).security(FUTURE).quantity(QUANTITY).price(99.550).build();
