...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	/// <summary>
	/// Test <seealso cref="FxVanillaOptionTradeCalculationFunction"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class FxVanillaOptionTradeCalculationFunctionTest
	public class FxVanillaOptionTradeCalculationFunctionTest
	{
	  ...
	  private static readonly FxVanillaOption OPTION_PRODUCT = FxVanillaOption.builder().longShort(SHORT).expiryDate(LocalDate.of(2014, 5, 9)).expiryTime(LocalTime.of(13, 10)).expiryZone(ZONE).underlying(FX_PRODUCT).build();
	  ...
	  public static readonly FxVanillaOptionTrade TRADE = FxVanillaOptionTrade.builder().premium(PREMIUM).product(OPTION_PRODUCT).info(TRADE_INFO).build();
	  public static readonly ResolvedFxVanillaOptionTrade RTRADE = TRADE.resolve(REF_DATA);
