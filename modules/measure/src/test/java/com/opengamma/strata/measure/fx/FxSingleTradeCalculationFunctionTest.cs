...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	/// <summary>
	/// Test <seealso cref="FxSingleTradeCalculationFunction"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class FxSingleTradeCalculationFunctionTest
	public class FxSingleTradeCalculationFunctionTest
	{
	  ...
	  private static readonly FxSingle PRODUCT = FxSingle.of(GBP_P1000, USD_M1600, date(2015, 6, 30));
	  public static readonly FxSingleTrade TRADE = FxSingleTrade.builder().product(PRODUCT).build();
	  public static readonly ResolvedFxSingleTrade RTRADE = TRADE.resolve(REF_DATA);
