...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	/// <summary>
	/// Test <seealso cref="CdsTradeCalculationFunction"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class CdsTradeCalculationFunctionTest
	public class CdsTradeCalculationFunctionTest
	{

	  private static readonly CdsTrade TRADE = CreditDataSet.CDS_TRADE;
	  private static readonly ResolvedCdsTrade RTRADE = CreditDataSet.RESOLVED_CDS_TRADE;
	  private static readonly CdsTradeCalculationFunction FUNCTION = new CdsTradeCalculationFunction();
	  private static readonly CreditRatesProvider RATES_PROVIDER = CreditDataSet.CDS_LOOKUP.marketDataView(CreditDataSet.MARKET_DATA.scenario(0)).creditRatesProvider();
	  private static readonly IsdaCdsTradePricer PRICER = new IsdaCdsTradePricer(AccrualOnDefaultFormula.CORRECT);
