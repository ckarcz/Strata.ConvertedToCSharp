...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="IborCapFloorMarketDataLookup"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class IborCapFloorMarketDataLookupTest
	public class IborCapFloorMarketDataLookupTest
	{

	  private static readonly IborCapletFloorletVolatilitiesId VOL_ID1 = IborCapletFloorletVolatilitiesId.of("USD1");
	  private static readonly IborCapletFloorletVolatilities MOCK_VOLS = mock(typeof(IborCapletFloorletVolatilities));
	  ...
	  static IborCapFloorMarketDataLookupTest()
	  {
