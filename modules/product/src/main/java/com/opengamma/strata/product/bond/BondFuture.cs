...
//ORIGINAL LINE: @SuppressWarnings("unchecked") @BeanDefinition(constructorScope = "package") public final class BondFuture implements com.opengamma.strata.product.SecuritizedProduct, com.opengamma.strata.basics.Resolvable<ResolvedBondFuture>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class BondFuture : SecuritizedProduct, Resolvable<ResolvedBondFuture>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.SecurityId securityId;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notEmpty") private final com.google.common.collect.ImmutableList<FixedCouponBond> deliveryBasket;
	  private readonly ImmutableList<FixedCouponBond> deliveryBasket;
	  /// <summary>
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  private void validate()
	  {
		...
		if (size > 1)
		{
		  ImmutableList<FixedCouponBond> bondsList = DeliveryBasket;
		  double notional = Notional;
		  Currency currency = Currency;
		  for (int i = 1; i < size; ++i)
		  {
			ArgChecker.isTrue(bondsList.get(i).Notional == notional, "Notional must be same for all bonds");
			ArgChecker.isTrue(bondsList.get(i).Currency.Equals(currency), "Currency must be same for all bonds");
		  }
		}
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java stream collectors are not converted by Java to C# Converter:
		IList<ResolvedFixedCouponBond> basket = deliveryBasket.Select(bond => bond.resolve(refData)).collect(toImmutableList());
		DaysAdjustment settleOffset = deliveryBasket.get(0).SettlementDateOffset;
		return ResolvedBondFuture.builder().securityId(securityId).deliveryBasket(basket).conversionFactors(conversionFactors).lastTradeDate(lastTradeDate).firstNoticeDate(firstNoticeDate).lastNoticeDate(lastNoticeDate).firstDeliveryDate(firstDeliveryDate != null ? firstDeliveryDate : settleOffset.adjust(firstNoticeDate, refData)).lastDeliveryDate(lastDeliveryDate != null ? lastDeliveryDate : settleOffset.adjust(lastNoticeDate, refData)).rounding(rounding).build();
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code BondFuture}. </summary>
	  ...
	  static BondFuture()
	  {
		MetaBean.register(BondFuture.Meta.INSTANCE);
	  }
	  ...
	  /// <param name="firstDeliveryDate">  the value of the property </param>
	  /// <param name="lastDeliveryDate">  the value of the property </param>
	  /// <param name="rounding">  the value of the property, not null </param>
	  internal BondFuture(SecurityId securityId, IList<FixedCouponBond> deliveryBasket, IList<double> conversionFactors, LocalDate lastTradeDate, LocalDate firstNoticeDate, LocalDate lastNoticeDate, LocalDate firstDeliveryDate, LocalDate lastDeliveryDate, Rounding rounding)
	  {
	  ...
	  public override BondFuture.Meta metaBean()
	  {
		return BondFuture.Meta.INSTANCE;
	  }
	  ...
	  public ImmutableList<FixedCouponBond> DeliveryBasket
	  {
		  get
		  {
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  securityId_Renamed = DirectMetaProperty.ofImmutable(this, "securityId", typeof(BondFuture), typeof(SecurityId));
			  deliveryBasket_Renamed = DirectMetaProperty.ofImmutable(this, "deliveryBasket", typeof(BondFuture), (Type) typeof(ImmutableList));
			  conversionFactors_Renamed = DirectMetaProperty.ofImmutable(this, "conversionFactors", typeof(BondFuture), (Type) typeof(ImmutableList));
			  lastTradeDate_Renamed = DirectMetaProperty.ofImmutable(this, "lastTradeDate", typeof(BondFuture), typeof(LocalDate));
			  firstNoticeDate_Renamed = DirectMetaProperty.ofImmutable(this, "firstNoticeDate", typeof(BondFuture), typeof(LocalDate));
			  lastNoticeDate_Renamed = DirectMetaProperty.ofImmutable(this, "lastNoticeDate", typeof(BondFuture), typeof(LocalDate));
			  firstDeliveryDate_Renamed = DirectMetaProperty.ofImmutable(this, "firstDeliveryDate", typeof(BondFuture), typeof(LocalDate));
			  lastDeliveryDate_Renamed = DirectMetaProperty.ofImmutable(this, "lastDeliveryDate", typeof(BondFuture), typeof(LocalDate));
			  rounding_Renamed = DirectMetaProperty.ofImmutable(this, "rounding", typeof(BondFuture), typeof(Rounding));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings({"unchecked", "rawtypes" }) private final org.joda.beans.MetaProperty<com.google.common.collect.ImmutableList<FixedCouponBond>> deliveryBasket = org.joda.beans.impl.direct.DirectMetaProperty.ofImmutable(this, "deliveryBasket", BondFuture.class, (Class) com.google.common.collect.ImmutableList.class);
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ImmutableList<FixedCouponBond>> deliveryBasket_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override BondFuture.Builder builder()
		{
		  return new BondFuture.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 1574023291: // securityId
			  return ((BondFuture) bean).SecurityId;
			case 1999764186: // deliveryBasket
			  return ((BondFuture) bean).DeliveryBasket;
			case 1655488270: // conversionFactors
			  return ((BondFuture) bean).ConversionFactors;
			case -1041950404: // lastTradeDate
			  return ((BondFuture) bean).LastTradeDate;
			case -1085415050: // firstNoticeDate
			  return ((BondFuture) bean).FirstNoticeDate;
			case -1060668964: // lastNoticeDate
			  return ((BondFuture) bean).LastNoticeDate;
			case 1755448466: // firstDeliveryDate
			  return ((BondFuture) bean).firstDeliveryDate;
			case -233366664: // lastDeliveryDate
			  return ((BondFuture) bean).lastDeliveryDate;
			case -142444: // rounding
			  return ((BondFuture) bean).Rounding;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<BondFuture>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal SecurityId securityId_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal IList<FixedCouponBond> deliveryBasket_Renamed = ImmutableList.of();
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(BondFuture beanToCopy)
		{
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") @Override public Builder set(String propertyName, Object newValue)
		public override Builder set(string propertyName, object newValue)
		{
		  switch (propertyName.GetHashCode())
		  {
			case 1574023291: // securityId
			  ...
			  break;
			case 1999764186: // deliveryBasket
			  this.deliveryBasket_Renamed = (IList<FixedCouponBond>) newValue;
			  break;
			case 1655488270: // conversionFactors
		...
		public override BondFuture build()
		{
		  return new BondFuture(securityId_Renamed, deliveryBasket_Renamed, conversionFactors_Renamed, lastTradeDate_Renamed, firstNoticeDate_Renamed, lastNoticeDate_Renamed, firstDeliveryDate_Renamed, lastDeliveryDate_Renamed, rounding_Renamed);
		}
		...
		/// <returns> this, for chaining, not null </returns>
		public Builder deliveryBasket(IList<FixedCouponBond> deliveryBasket)
		{
		  JodaBeanUtils.notEmpty(deliveryBasket, "deliveryBasket");
		...
		/// <param name="deliveryBasket">  the new value, not empty </param>
		/// <returns> this, for chaining, not null </returns>
		public Builder deliveryBasket(params FixedCouponBond[] deliveryBasket)
		{
