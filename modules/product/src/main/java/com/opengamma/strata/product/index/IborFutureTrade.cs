...
namespace com.opengamma.strata.product.index
{
	...
	/// <para>
	/// A trade in an underlying <seealso cref="IborFuture"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class IborFutureTrade implements com.opengamma.strata.product.SecuritizedProductTrade<IborFuture>, com.opengamma.strata.product.ResolvableTrade<ResolvedIborFutureTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class IborFutureTrade : SecuritizedProductTrade<IborFuture>, ResolvableTrade<ResolvedIborFutureTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code IborFutureTrade}. </summary>
	  ...
	  internal IborFutureTrade(TradeInfo info, IborFuture product, double quantity, double price)
	  {
	  ...
	  public override IborFutureTrade.Meta metaBean()
	  {
		return IborFutureTrade.Meta.INSTANCE;
	  }
	  ...
	  /// The trade date is required when calling <seealso cref="IborFutureTrade#resolve(ReferenceData)"/>.
	  /// </para>
	  /// </summary>
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(IborFutureTrade), typeof(TradeInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(IborFutureTrade), typeof(IborFuture));
			  quantity_Renamed = DirectMetaProperty.ofImmutable(this, "quantity", typeof(IborFutureTrade), Double.TYPE);
			  price_Renamed = DirectMetaProperty.ofImmutable(this, "price", typeof(IborFutureTrade), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override IborFutureTrade.Builder builder()
		{
		  return new IborFutureTrade.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((IborFutureTrade) bean).Info;
			case -309474065: // product
			  return ((IborFutureTrade) bean).Product;
			case -1285004149: // quantity
			  return ((IborFutureTrade) bean).Quantity;
			case 106934601: // price
			  return ((IborFutureTrade) bean).Price;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<IborFutureTrade>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override IborFutureTrade build()
		{
		  return new IborFutureTrade(info_Renamed, product_Renamed, quantity_Renamed, price_Renamed);
		}
