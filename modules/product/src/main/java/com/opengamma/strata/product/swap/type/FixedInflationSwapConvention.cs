...
namespace com.opengamma.strata.product.swap.type
{
	...
	/// </para>
	/// <para>
	/// To manually create a convention, see <seealso cref="ImmutableFixedInflationSwapConvention"/>.
	/// To register a specific convention, see {@code InflationSwapConvention.ini}.
	/// </para>
	/// </summary>
	public interface FixedInflationSwapConvention : SingleCurrencySwapConvention, Named
	{
...
//ORIGINAL LINE: @FromString public static FixedInflationSwapConvention of(String uniqueName)
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//	  public static com.opengamma.strata.collect.named.ExtendedEnum<FixedInflationSwapConvention> extendedEnum()
	//  {
	...
	//  }
	  ...
	  InflationRateSwapLegConvention FloatingLeg {get;}
	  ...
	  /// <param name="tenor">  the tenor of the trade </param>
