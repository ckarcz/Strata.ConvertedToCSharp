...
namespace com.opengamma.strata.product.bond
{
	...
	/// <para>
	/// A position in an underlying <seealso cref="CapitalIndexedBond"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class CapitalIndexedBondPosition implements com.opengamma.strata.product.SecuritizedProductPosition<CapitalIndexedBond>, com.opengamma.strata.basics.Resolvable<ResolvedCapitalIndexedBondTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class CapitalIndexedBondPosition : SecuritizedProductPosition<CapitalIndexedBond>, Resolvable<ResolvedCapitalIndexedBondTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Override @DerivedProperty public double getQuantity()
	  ...
	  {
		return CapitalIndexedBondPosition.ofNet(info, product, quantity);
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code CapitalIndexedBondPosition}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static CapitalIndexedBondPosition.Meta meta()
	  {
		return CapitalIndexedBondPosition.Meta.INSTANCE;
	  }

	  static CapitalIndexedBondPosition()
	  {
		MetaBean.register(CapitalIndexedBondPosition.Meta.INSTANCE);
	  }
	  ...
	  {
		return new CapitalIndexedBondPosition.Builder();
	  }
	  ...
	  internal CapitalIndexedBondPosition(PositionInfo info, CapitalIndexedBond product, double longQuantity, double shortQuantity)
	  {
	  ...
	  public override CapitalIndexedBondPosition.Meta metaBean()
	  {
		return CapitalIndexedBondPosition.Meta.INSTANCE;
	  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The meta-bean for {@code CapitalIndexedBondPosition}.
	  /// </summary>
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(CapitalIndexedBondPosition), typeof(PositionInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(CapitalIndexedBondPosition), typeof(CapitalIndexedBond));
			  longQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "longQuantity", typeof(CapitalIndexedBondPosition), Double.TYPE);
			  shortQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "shortQuantity", typeof(CapitalIndexedBondPosition), Double.TYPE);
			  quantity_Renamed = DirectMetaProperty.ofDerived(this, "quantity", typeof(CapitalIndexedBondPosition), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override CapitalIndexedBondPosition.Builder builder()
		{
		  return new CapitalIndexedBondPosition.Builder();
		}
		...
		{
		  return typeof(CapitalIndexedBondPosition);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((CapitalIndexedBondPosition) bean).Info;
			case -309474065: // product
			  return ((CapitalIndexedBondPosition) bean).Product;
			case 611668775: // longQuantity
			  return ((CapitalIndexedBondPosition) bean).LongQuantity;
			case -2094395097: // shortQuantity
			  return ((CapitalIndexedBondPosition) bean).ShortQuantity;
			case -1285004149: // quantity
			  return ((CapitalIndexedBondPosition) bean).Quantity;
		  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The bean-builder for {@code CapitalIndexedBondPosition}.
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<CapitalIndexedBondPosition>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override CapitalIndexedBondPosition build()
		{
		  return new CapitalIndexedBondPosition(info_Renamed, product_Renamed, longQuantity_Renamed, shortQuantity_Renamed);
		}
