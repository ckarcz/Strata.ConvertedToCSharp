...
namespace com.opengamma.strata.product.index
{
	...
	/// <para>
	/// This is the resolved form of <seealso cref="OvernightFutureTrade"/> and is the primary input to the pricers.
	/// Applications will typically create a {@code ResolvedOvernightFutureTrade} from a {@code OvernightFutureTrade}
	/// using <seealso cref="OvernightFutureTrade#resolve(ReferenceData)"/>.
	/// </para>
	/// <para>
	/// A {@code ResolvedOvernightFutureTrade} is bound to data that changes over time, such as holiday calendars.
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class ResolvedOvernightFutureTrade implements com.opengamma.strata.product.ResolvedTrade, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ResolvedOvernightFutureTrade : ResolvedTrade, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.PortfolioItemInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final ResolvedOvernightFuture product;
	  private readonly ResolvedOvernightFuture product;
	  /// <summary>
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ResolvedOvernightFutureTrade}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static ResolvedOvernightFutureTrade.Meta meta()
	  {
		return ResolvedOvernightFutureTrade.Meta.INSTANCE;
	  }

	  static ResolvedOvernightFutureTrade()
	  {
		MetaBean.register(ResolvedOvernightFutureTrade.Meta.INSTANCE);
	  }
	  ...
	  {
		return new ResolvedOvernightFutureTrade.Builder();
	  }
	  ...
	  public override ResolvedOvernightFutureTrade.Meta metaBean()
	  {
		return ResolvedOvernightFutureTrade.Meta.INSTANCE;
	  }
	  ...
	  /// </summary>
	  /// <returns> the value of the property, not null </returns>
	  public ResolvedOvernightFuture Product
	  {
		  get
		  {
			return product;
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The meta-bean for {@code ResolvedOvernightFutureTrade}.
	  /// </summary>
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(ResolvedOvernightFutureTrade), typeof(PortfolioItemInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(ResolvedOvernightFutureTrade), typeof(ResolvedOvernightFuture));
			  quantity_Renamed = DirectMetaProperty.ofImmutable(this, "quantity", typeof(ResolvedOvernightFutureTrade), Double.TYPE);
			  tradedPrice_Renamed = DirectMetaProperty.ofImmutable(this, "tradedPrice", typeof(ResolvedOvernightFutureTrade), typeof(TradedPrice));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ResolvedOvernightFuture> product_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ResolvedOvernightFutureTrade.Builder builder()
		{
		  return new ResolvedOvernightFutureTrade.Builder();
		}
		...
		{
		  return typeof(ResolvedOvernightFutureTrade);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		/// <returns> the meta-property, not null </returns>
		public MetaProperty<ResolvedOvernightFuture> product()
		{
		  return product_Renamed;
		}
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((ResolvedOvernightFutureTrade) bean).Info;
			case -309474065: // product
			  return ((ResolvedOvernightFutureTrade) bean).Product;
			case -1285004149: // quantity
			  return ((ResolvedOvernightFutureTrade) bean).Quantity;
			case -1873824343: // tradedPrice
			  return ((ResolvedOvernightFutureTrade) bean).tradedPrice;
		  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The bean-builder for {@code ResolvedOvernightFutureTrade}.
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ResolvedOvernightFutureTrade>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal PortfolioItemInfo info_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ResolvedOvernightFuture product_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override ResolvedOvernightFutureTrade build()
		{
		  return new ResolvedOvernightFutureTrade(info_Renamed, product_Renamed, quantity_Renamed, tradedPrice_Renamed);
		}
		...
		{
		  StringBuilder buf = new StringBuilder(160);
		  buf.Append("ResolvedOvernightFutureTrade.Builder{");
