...
namespace com.opengamma.strata.product.credit
{
	...
	/// <para>
	/// This is the resolved form of <seealso cref="CdsIndexTrade"/> and is the primary input to the pricers.
	/// Applications will typically create a {@code ResolvedCdsIndexTrade} from a {@code CdsIndexTrade}
	/// using <seealso cref="CdsIndexTrade#resolve(ReferenceData)"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition public final class ResolvedCdsIndexTrade implements com.opengamma.strata.product.ResolvedTrade, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ResolvedCdsIndexTrade : ResolvedTrade, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.TradeInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final ResolvedCdsIndex product;
	  private readonly ResolvedCdsIndex product;
	  /// <summary>
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ResolvedCdsIndexTrade}. </summary>
	  ...
	  static ResolvedCdsIndexTrade()
	  {
		MetaBean.register(ResolvedCdsIndexTrade.Meta.INSTANCE);
	  }
	  ...
	  public override ResolvedCdsIndexTrade.Meta metaBean()
	  {
		return ResolvedCdsIndexTrade.Meta.INSTANCE;
	  }
	  ...
	  /// </summary>
	  /// <returns> the value of the property, not null </returns>
	  public ResolvedCdsIndex Product
	  {
		  get
		  {
			return product;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(ResolvedCdsIndexTrade), typeof(TradeInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(ResolvedCdsIndexTrade), typeof(ResolvedCdsIndex));
			  upfrontFee_Renamed = DirectMetaProperty.ofImmutable(this, "upfrontFee", typeof(ResolvedCdsIndexTrade), typeof(Payment));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ResolvedCdsIndex> product_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ResolvedCdsIndexTrade.Builder builder()
		{
		  return new ResolvedCdsIndexTrade.Builder();
		}
		...
		{
		  return typeof(ResolvedCdsIndexTrade);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((ResolvedCdsIndexTrade) bean).Info;
			case -309474065: // product
			  return ((ResolvedCdsIndexTrade) bean).Product;
			case 963468344: // upfrontFee
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ResolvedCdsIndexTrade>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal TradeInfo info_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ResolvedCdsIndex product_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override ResolvedCdsIndexTrade build()
		{
		  return new ResolvedCdsIndexTrade(info_Renamed, product_Renamed, upfrontFee_Renamed);
		}
