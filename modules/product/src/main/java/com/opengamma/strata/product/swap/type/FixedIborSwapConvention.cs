...
namespace com.opengamma.strata.product.swap.type
{
	...
	/// </para>
	/// <para>
	/// To manually create a convention, see <seealso cref="ImmutableFixedIborSwapConvention"/>.
	/// To register a specific convention, see {@code FixedIborSwapConvention.ini}.
	/// </para>
	/// </summary>
	public interface FixedIborSwapConvention : SingleCurrencySwapConvention, Named
	{
...
//ORIGINAL LINE: @FromString public static FixedIborSwapConvention of(String uniqueName)
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//	  public static com.opengamma.strata.collect.named.ExtendedEnum<FixedIborSwapConvention> extendedEnum()
	//  {
	...
	//  }
	  ...
	  IborRateSwapLegConvention FloatingLeg {get;}
