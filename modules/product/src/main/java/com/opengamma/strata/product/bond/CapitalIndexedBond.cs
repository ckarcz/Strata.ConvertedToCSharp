...
//	import static com.opengamma.strata.basics.value.ValueSchedule.ALWAYS_1;
	...
	/// The payment amount will be computed based on this schedule and <seealso cref="RateComputation"/> of {@code InflationRateCalculation}.
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class CapitalIndexedBond implements com.opengamma.strata.product.SecuritizedProduct, com.opengamma.strata.basics.Resolvable<ResolvedCapitalIndexedBond>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class CapitalIndexedBond : SecuritizedProduct, Resolvable<ResolvedCapitalIndexedBond>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  public ResolvedCapitalIndexedBond resolve(ReferenceData refData)
	  {
		...
		DoubleArray resolvedGearings = rateCalculation.Gearing.orElse(ALWAYS_1).resolveValues(adjustedSchedule);
		...
		for (int i = 0; i < adjustedSchedule.size(); i++)
		{
		  ...
		  bondPeriodsBuilder.add(CapitalIndexedBondPaymentPeriod.builder().unadjustedStartDate(period.UnadjustedStartDate).unadjustedEndDate(period.UnadjustedEndDate).startDate(period.StartDate).endDate(period.EndDate).detachmentDate(exCouponPeriodAdjuster.adjust(period.EndDate)).notional(notional).currency(currency).rateComputation(rateCalculation.createRateComputation(period.EndDate)).realCoupon(resolvedGearings.get(i)).build());
		}
		ImmutableList<CapitalIndexedBondPaymentPeriod> bondPeriods = bondPeriodsBuilder.build();
		// nominal payment
		CapitalIndexedBondPaymentPeriod nominalPayment = bondPeriods.get(bondPeriods.size() - 1).withUnitCoupon(bondPeriods.get(0).StartDate, bondPeriods.get(0).UnadjustedStartDate);
		return ResolvedCapitalIndexedBond.builder().securityId(securityId).periodicPayments(ImmutableList.copyOf(bondPeriods)).frequency(accrualSchedule.Frequency).rollConvention(accrualSchedule.calculatedRollConvention()).dayCount(dayCount).yieldConvention(yieldConvention).settlementDateOffset(settlementDateOffset).legalEntityId(legalEntityId).nominalPayment(nominalPayment).rateCalculation(rateCalculation).build();
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code CapitalIndexedBond}. </summary>
	  ...
	  {
		MetaBean.register(CapitalIndexedBond.Meta.INSTANCE);
	  }
	  ...
	  /// <param name="accrualSchedule">  the value of the property, not null </param>
	  /// <param name="rateCalculation">  the value of the property, not null </param>
	  ...
	  /// <param name="exCouponPeriod">  the value of the property, not null </param>
	  internal CapitalIndexedBond(SecurityId securityId, Currency currency, double notional, PeriodicSchedule accrualSchedule, InflationRateCalculation rateCalculation, DayCount dayCount, CapitalIndexedBondYieldConvention yieldConvention, LegalEntityId legalEntityId, DaysAdjustment settlementDateOffset, DaysAdjustment exCouponPeriod)
	  {
	  ...
	  public override CapitalIndexedBond.Meta metaBean()
	  {
		return CapitalIndexedBond.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  securityId_Renamed = DirectMetaProperty.ofImmutable(this, "securityId", typeof(CapitalIndexedBond), typeof(SecurityId));
			  currency_Renamed = DirectMetaProperty.ofImmutable(this, "currency", typeof(CapitalIndexedBond), typeof(Currency));
			  notional_Renamed = DirectMetaProperty.ofImmutable(this, "notional", typeof(CapitalIndexedBond), Double.TYPE);
			  accrualSchedule_Renamed = DirectMetaProperty.ofImmutable(this, "accrualSchedule", typeof(CapitalIndexedBond), typeof(PeriodicSchedule));
			  rateCalculation_Renamed = DirectMetaProperty.ofImmutable(this, "rateCalculation", typeof(CapitalIndexedBond), typeof(InflationRateCalculation));
			  dayCount_Renamed = DirectMetaProperty.ofImmutable(this, "dayCount", typeof(CapitalIndexedBond), typeof(DayCount));
			  yieldConvention_Renamed = DirectMetaProperty.ofImmutable(this, "yieldConvention", typeof(CapitalIndexedBond), typeof(CapitalIndexedBondYieldConvention));
			  legalEntityId_Renamed = DirectMetaProperty.ofImmutable(this, "legalEntityId", typeof(CapitalIndexedBond), typeof(LegalEntityId));
			  settlementDateOffset_Renamed = DirectMetaProperty.ofImmutable(this, "settlementDateOffset", typeof(CapitalIndexedBond), typeof(DaysAdjustment));
			  exCouponPeriod_Renamed = DirectMetaProperty.ofImmutable(this, "exCouponPeriod", typeof(CapitalIndexedBond), typeof(DaysAdjustment));
			  metaPropertyMap$ = new DirectMetaPropertyMap(this, null, "securityId", "currency", "notional", "accrualSchedule", "rateCalculation", "dayCount", "yieldConvention", "legalEntityId", "settlementDateOffset", "exCouponPeriod");
		  }
...
//ORIGINAL LINE: private final java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap$ = new org.joda.beans.impl.direct.DirectMetaPropertyMap(this, null, "securityId", "currency", "notional", "accrualSchedule", "rateCalculation", "dayCount", "yieldConvention", "legalEntityId", "settlementDateOffset", "exCouponPeriod");
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override CapitalIndexedBond.Builder builder()
		{
		  return new CapitalIndexedBond.Builder();
		}
		...
		{
		  return typeof(CapitalIndexedBond);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 1574023291: // securityId
			  return ((CapitalIndexedBond) bean).SecurityId;
			case 575402001: // currency
			  return ((CapitalIndexedBond) bean).Currency;
			case 1585636160: // notional
			  return ((CapitalIndexedBond) bean).Notional;
			case 304659814: // accrualSchedule
			  return ((CapitalIndexedBond) bean).AccrualSchedule;
			case -521703991: // rateCalculation
			  return ((CapitalIndexedBond) bean).RateCalculation;
			case 1905311443: // dayCount
			  return ((CapitalIndexedBond) bean).DayCount;
			case -1895216418: // yieldConvention
			  return ((CapitalIndexedBond) bean).YieldConvention;
			case 866287159: // legalEntityId
			  return ((CapitalIndexedBond) bean).LegalEntityId;
			case 135924714: // settlementDateOffset
			  return ((CapitalIndexedBond) bean).SettlementDateOffset;
			case 1408037338: // exCouponPeriod
			  return ((CapitalIndexedBond) bean).ExCouponPeriod;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<CapitalIndexedBond>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(CapitalIndexedBond beanToCopy)
		{
		...
		public override CapitalIndexedBond build()
		{
		  return new CapitalIndexedBond(securityId_Renamed, currency_Renamed, notional_Renamed, accrualSchedule_Renamed, rateCalculation_Renamed, dayCount_Renamed, yieldConvention_Renamed, legalEntityId_Renamed, settlementDateOffset_Renamed, exCouponPeriod_Renamed);
		}
