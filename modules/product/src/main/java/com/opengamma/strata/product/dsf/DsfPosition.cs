...
namespace com.opengamma.strata.product.dsf
{
	...
	/// A position in a DSF.
	/// <para>
	/// A position in an underlying <seealso cref="Dsf"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class DsfPosition implements com.opengamma.strata.product.SecuritizedProductPosition<Dsf>, com.opengamma.strata.basics.Resolvable<ResolvedDsfTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class DsfPosition : SecuritizedProductPosition<Dsf>, Resolvable<ResolvedDsfTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "ArgChecker.notNegative") private final double shortQuantity;
	  ...
	  /// <returns> the position </returns>
	  public static DsfPosition ofLongShort(PositionInfo positionInfo, Dsf product, double longQuantity, double shortQuantity)
	  {
...
//ORIGINAL LINE: @Override @DerivedProperty public double getQuantity()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code DsfPosition}. </summary>
	  ...
	  internal DsfPosition(PositionInfo info, Dsf product, double longQuantity, double shortQuantity)
	  {
	  ...
	  public override DsfPosition.Meta metaBean()
	  {
		return DsfPosition.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(DsfPosition), typeof(PositionInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(DsfPosition), typeof(Dsf));
			  longQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "longQuantity", typeof(DsfPosition), Double.TYPE);
			  shortQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "shortQuantity", typeof(DsfPosition), Double.TYPE);
			  quantity_Renamed = DirectMetaProperty.ofDerived(this, "quantity", typeof(DsfPosition), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override DsfPosition.Builder builder()
		{
		  return new DsfPosition.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((DsfPosition) bean).Info;
			case -309474065: // product
			  return ((DsfPosition) bean).Product;
			case 611668775: // longQuantity
			  return ((DsfPosition) bean).LongQuantity;
			case -2094395097: // shortQuantity
			  return ((DsfPosition) bean).ShortQuantity;
			case -1285004149: // quantity
			  return ((DsfPosition) bean).Quantity;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<DsfPosition>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override DsfPosition build()
		{
		  return new DsfPosition(info_Renamed, product_Renamed, longQuantity_Renamed, shortQuantity_Renamed);
		}
