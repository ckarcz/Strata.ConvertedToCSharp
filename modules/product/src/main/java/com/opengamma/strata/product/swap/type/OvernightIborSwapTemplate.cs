...
namespace com.opengamma.strata.product.swap.type
{
	...
	/// <para>
	/// This defines almost all the data necessary to create an Overnight-Ibor single currency <seealso cref="SwapTrade"/>.
...
//ORIGINAL LINE: @BeanDefinition public final class OvernightIborSwapTemplate implements com.opengamma.strata.product.TradeTemplate, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class OvernightIborSwapTemplate : TradeTemplate, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.basics.date.Tenor tenor;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final OvernightIborSwapConvention convention;
	  private readonly OvernightIborSwapConvention convention;
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  /// <param name="spread">  the spread, applied to the Overnight leg </param>
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code OvernightIborSwapTemplate}. </summary>
	  ...
	  public override OvernightIborSwapTemplate.Meta metaBean()
	  {
		return OvernightIborSwapTemplate.Meta.INSTANCE;
	  }
	  ...
	  /// <returns> the value of the property, not null </returns>
	  public OvernightIborSwapConvention Convention
	  {
		  get
		  {
			return convention;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  periodToStart_Renamed = DirectMetaProperty.ofImmutable(this, "periodToStart", typeof(OvernightIborSwapTemplate), typeof(Period));
			  tenor_Renamed = DirectMetaProperty.ofImmutable(this, "tenor", typeof(OvernightIborSwapTemplate), typeof(Tenor));
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(OvernightIborSwapTemplate), typeof(OvernightIborSwapConvention));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<OvernightIborSwapConvention> convention_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override OvernightIborSwapTemplate.Builder builder()
		{
		  return new OvernightIborSwapTemplate.Builder();
		}
		...
		{
		  return typeof(OvernightIborSwapTemplate);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -574688858: // periodToStart
			  return ((OvernightIborSwapTemplate) bean).PeriodToStart;
			case 110246592: // tenor
			  return ((OvernightIborSwapTemplate) bean).Tenor;
			case 2039569265: // convention
			  return ((OvernightIborSwapTemplate) bean).Convention;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<OvernightIborSwapTemplate>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal OvernightIborSwapConvention convention_Renamed;
		...
		public override OvernightIborSwapTemplate build()
		{
		  return new OvernightIborSwapTemplate(periodToStart_Renamed, tenor_Renamed, convention_Renamed);
		}
