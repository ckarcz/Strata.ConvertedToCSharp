...
//ORIGINAL LINE: @BeanDefinition public final class ImmutableXCcyIborIborSwapConvention implements XCcyIborIborSwapConvention, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ImmutableXCcyIborIborSwapConvention : XCcyIborIborSwapConvention, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  {
		ArgChecker.isFalse(spreadLeg.Currency.Equals(flatLeg.Currency), "Conventions must have different currencies");
	  }
	  ...
	  public SwapTrade toTrade(TradeInfo tradeInfo, LocalDate startDate, LocalDate endDate, BuySell buySell, double notionalSpreadLeg, double notionalFlatLeg, double spread)
	  {
		...
		SwapLeg leg1 = spreadLeg.toLeg(startDate, endDate, PayReceive.ofPay(buySell.Buy), notionalSpreadLeg, spread);
		SwapLeg leg2 = flatLeg.toLeg(startDate, endDate, PayReceive.ofPay(buySell.Sell), notionalFlatLeg);
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ImmutableXCcyIborIborSwapConvention}. </summary>
	  ...
	  {
		MetaBean.register(ImmutableXCcyIborIborSwapConvention.Meta.INSTANCE);
	  }
	  ...
	  private ImmutableXCcyIborIborSwapConvention(string name, IborRateSwapLegConvention spreadLeg, IborRateSwapLegConvention flatLeg, DaysAdjustment spotDateOffset)
	  {
	  ...
	  public override ImmutableXCcyIborIborSwapConvention.Meta metaBean()
	  {
		return ImmutableXCcyIborIborSwapConvention.Meta.INSTANCE;
	  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// Gets the convention name, such as 'EUR-EURIBOR-3M-USD-LIBOR-3M'. </summary>
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  name_Renamed = DirectMetaProperty.ofImmutable(this, "name", typeof(ImmutableXCcyIborIborSwapConvention), typeof(string));
			  spreadLeg_Renamed = DirectMetaProperty.ofImmutable(this, "spreadLeg", typeof(ImmutableXCcyIborIborSwapConvention), typeof(IborRateSwapLegConvention));
			  flatLeg_Renamed = DirectMetaProperty.ofImmutable(this, "flatLeg", typeof(ImmutableXCcyIborIborSwapConvention), typeof(IborRateSwapLegConvention));
			  spotDateOffset_Renamed = DirectMetaProperty.ofImmutable(this, "spotDateOffset", typeof(ImmutableXCcyIborIborSwapConvention), typeof(DaysAdjustment));
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ImmutableXCcyIborIborSwapConvention.Builder builder()
		{
		  return new ImmutableXCcyIborIborSwapConvention.Builder();
		}
		...
		{
		  return typeof(ImmutableXCcyIborIborSwapConvention);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3373707: // name
			  return ((ImmutableXCcyIborIborSwapConvention) bean).Name;
			case 1302781851: // spreadLeg
			  return ((ImmutableXCcyIborIborSwapConvention) bean).SpreadLeg;
			case -778843179: // flatLeg
			  return ((ImmutableXCcyIborIborSwapConvention) bean).FlatLeg;
			case 746995843: // spotDateOffset
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ImmutableXCcyIborIborSwapConvention>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(ImmutableXCcyIborIborSwapConvention beanToCopy)
		{
		...
		public override ImmutableXCcyIborIborSwapConvention build()
		{
		  return new ImmutableXCcyIborIborSwapConvention(name_Renamed, spreadLeg_Renamed, flatLeg_Renamed, spotDateOffset_Renamed);
		}

		//-----------------------------------------------------------------------
		/// <summary>
		/// Sets the convention name, such as 'EUR-EURIBOR-3M-USD-LIBOR-3M'. </summary>
