...
namespace com.opengamma.strata.product.swap.type
{
	...
	/// <para>
	/// This defines almost all the data necessary to create a Ibor-Ibor single currency <seealso cref="SwapTrade"/>.
...
//ORIGINAL LINE: @BeanDefinition public final class IborIborSwapTemplate implements com.opengamma.strata.product.TradeTemplate, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class IborIborSwapTemplate : TradeTemplate, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.basics.date.Tenor tenor;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final IborIborSwapConvention convention;
	  private readonly IborIborSwapConvention convention;
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code IborIborSwapTemplate}. </summary>
	  ...
	  {
		MetaBean.register(IborIborSwapTemplate.Meta.INSTANCE);
	  }
	  ...
	  public override IborIborSwapTemplate.Meta metaBean()
	  {
		return IborIborSwapTemplate.Meta.INSTANCE;
	  }
	  ...
	  /// <returns> the value of the property, not null </returns>
	  public IborIborSwapConvention Convention
	  {
		  get
		  {
			return convention;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  periodToStart_Renamed = DirectMetaProperty.ofImmutable(this, "periodToStart", typeof(IborIborSwapTemplate), typeof(Period));
			  tenor_Renamed = DirectMetaProperty.ofImmutable(this, "tenor", typeof(IborIborSwapTemplate), typeof(Tenor));
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(IborIborSwapTemplate), typeof(IborIborSwapConvention));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<IborIborSwapConvention> convention_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override IborIborSwapTemplate.Builder builder()
		{
		  return new IborIborSwapTemplate.Builder();
		}
		...
		{
		  return typeof(IborIborSwapTemplate);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -574688858: // periodToStart
			  return ((IborIborSwapTemplate) bean).PeriodToStart;
			case 110246592: // tenor
			  return ((IborIborSwapTemplate) bean).Tenor;
			case 2039569265: // convention
			  return ((IborIborSwapTemplate) bean).Convention;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<IborIborSwapTemplate>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal IborIborSwapConvention convention_Renamed;
		...
		public override IborIborSwapTemplate build()
		{
		  return new IborIborSwapTemplate(periodToStart_Renamed, tenor_Renamed, convention_Renamed);
		}
