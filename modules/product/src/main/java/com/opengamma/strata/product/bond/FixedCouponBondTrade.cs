...
namespace com.opengamma.strata.product.bond
{
	...
	/// <para>
	/// A trade in an underlying <seealso cref="FixedCouponBond"/>.
	/// 
	/// <h4>Price</h4>
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class FixedCouponBondTrade implements com.opengamma.strata.product.SecuritizedProductTrade<FixedCouponBond>, com.opengamma.strata.product.ResolvableTrade<ResolvedFixedCouponBondTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FixedCouponBondTrade : SecuritizedProductTrade<FixedCouponBond>, ResolvableTrade<ResolvedFixedCouponBondTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  private LocalDate calculateSettlementDate(ReferenceData refData)
	  {
		...
		throw new System.InvalidOperationException("FixedCouponBondTrade.resolve() requires either trade date or settlement date");
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FixedCouponBondTrade}. </summary>
	  ...
	  internal FixedCouponBondTrade(TradeInfo info, FixedCouponBond product, double quantity, double price)
	  {
	  ...
	  public override FixedCouponBondTrade.Meta metaBean()
	  {
		return FixedCouponBondTrade.Meta.INSTANCE;
	  }
	  ...
	  /// Either the trade or settlement date is required when calling <seealso cref="FixedCouponBondTrade#resolve(ReferenceData)"/>.
	  /// </para>
	  /// </summary>
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(FixedCouponBondTrade), typeof(TradeInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(FixedCouponBondTrade), typeof(FixedCouponBond));
			  quantity_Renamed = DirectMetaProperty.ofImmutable(this, "quantity", typeof(FixedCouponBondTrade), Double.TYPE);
			  price_Renamed = DirectMetaProperty.ofImmutable(this, "price", typeof(FixedCouponBondTrade), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override FixedCouponBondTrade.Builder builder()
		{
		  return new FixedCouponBondTrade.Builder();
		}
		...
		{
		  return typeof(FixedCouponBondTrade);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((FixedCouponBondTrade) bean).Info;
			case -309474065: // product
			  return ((FixedCouponBondTrade) bean).Product;
			case -1285004149: // quantity
			  return ((FixedCouponBondTrade) bean).Quantity;
			case 106934601: // price
			  return ((FixedCouponBondTrade) bean).Price;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<FixedCouponBondTrade>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override FixedCouponBondTrade build()
		{
		  return new FixedCouponBondTrade(info_Renamed, product_Renamed, quantity_Renamed, price_Renamed);
		}
