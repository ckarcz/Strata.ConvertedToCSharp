...
namespace com.opengamma.strata.product.bond
{
	...
	/// </para>
	/// <para>
	/// The periodic coupon payment schedule is defined using <seealso cref="PeriodicSchedule"/>. 
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class FixedCouponBond implements com.opengamma.strata.product.SecuritizedProduct, com.opengamma.strata.basics.Resolvable<ResolvedFixedCouponBond>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FixedCouponBond : SecuritizedProduct, Resolvable<ResolvedFixedCouponBond>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  public ResolvedFixedCouponBond resolve(ReferenceData refData)
	  {
		...
		for (int i = 0; i < adjustedSchedule.size(); i++)
		{
		  ...
		  accrualPeriods.add(FixedCouponBondPaymentPeriod.builder().unadjustedStartDate(period.UnadjustedStartDate).unadjustedEndDate(period.UnadjustedEndDate).startDate(period.StartDate).endDate(period.EndDate).detachmentDate(exCouponPeriodAdjuster.adjust(period.EndDate)).notional(notional).currency(currency).fixedRate(fixedRate).yearFraction(unadjustedPeriod.yearFraction(dayCount, unadjustedSchedule)).build());
		}
		...
		Payment nominalPayment = Payment.of(CurrencyAmount.of(currency, notional), lastPeriod.PaymentDate);
		return ResolvedFixedCouponBond.builder().securityId(securityId).legalEntityId(legalEntityId).nominalPayment(nominalPayment).periodicPayments(ImmutableList.copyOf(periodicPayments)).frequency(accrualSchedule.Frequency).rollConvention(accrualSchedule.calculatedRollConvention()).fixedRate(fixedRate).dayCount(dayCount).yieldConvention(yieldConvention).settlementDateOffset(settlementDateOffset).build();
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FixedCouponBond}. </summary>
	  ...
	  internal FixedCouponBond(SecurityId securityId, Currency currency, double notional, PeriodicSchedule accrualSchedule, double fixedRate, DayCount dayCount, FixedCouponBondYieldConvention yieldConvention, LegalEntityId legalEntityId, DaysAdjustment settlementDateOffset, DaysAdjustment exCouponPeriod)
	  {
	  ...
	  public override FixedCouponBond.Meta metaBean()
	  {
		return FixedCouponBond.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  securityId_Renamed = DirectMetaProperty.ofImmutable(this, "securityId", typeof(FixedCouponBond), typeof(SecurityId));
			  currency_Renamed = DirectMetaProperty.ofImmutable(this, "currency", typeof(FixedCouponBond), typeof(Currency));
			  notional_Renamed = DirectMetaProperty.ofImmutable(this, "notional", typeof(FixedCouponBond), Double.TYPE);
			  accrualSchedule_Renamed = DirectMetaProperty.ofImmutable(this, "accrualSchedule", typeof(FixedCouponBond), typeof(PeriodicSchedule));
			  fixedRate_Renamed = DirectMetaProperty.ofImmutable(this, "fixedRate", typeof(FixedCouponBond), Double.TYPE);
			  dayCount_Renamed = DirectMetaProperty.ofImmutable(this, "dayCount", typeof(FixedCouponBond), typeof(DayCount));
			  yieldConvention_Renamed = DirectMetaProperty.ofImmutable(this, "yieldConvention", typeof(FixedCouponBond), typeof(FixedCouponBondYieldConvention));
			  legalEntityId_Renamed = DirectMetaProperty.ofImmutable(this, "legalEntityId", typeof(FixedCouponBond), typeof(LegalEntityId));
			  settlementDateOffset_Renamed = DirectMetaProperty.ofImmutable(this, "settlementDateOffset", typeof(FixedCouponBond), typeof(DaysAdjustment));
			  exCouponPeriod_Renamed = DirectMetaProperty.ofImmutable(this, "exCouponPeriod", typeof(FixedCouponBond), typeof(DaysAdjustment));
			  metaPropertyMap$ = new DirectMetaPropertyMap(this, null, "securityId", "currency", "notional", "accrualSchedule", "fixedRate", "dayCount", "yieldConvention", "legalEntityId", "settlementDateOffset", "exCouponPeriod");
		  }
...
//ORIGINAL LINE: private final java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap$ = new org.joda.beans.impl.direct.DirectMetaPropertyMap(this, null, "securityId", "currency", "notional", "accrualSchedule", "fixedRate", "dayCount", "yieldConvention", "legalEntityId", "settlementDateOffset", "exCouponPeriod");
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override FixedCouponBond.Builder builder()
		{
		  return new FixedCouponBond.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 1574023291: // securityId
			  return ((FixedCouponBond) bean).SecurityId;
			case 575402001: // currency
			  return ((FixedCouponBond) bean).Currency;
			case 1585636160: // notional
			  return ((FixedCouponBond) bean).Notional;
			case 304659814: // accrualSchedule
			  return ((FixedCouponBond) bean).AccrualSchedule;
			case 747425396: // fixedRate
			  return ((FixedCouponBond) bean).FixedRate;
			case 1905311443: // dayCount
			  return ((FixedCouponBond) bean).DayCount;
			case -1895216418: // yieldConvention
			  return ((FixedCouponBond) bean).YieldConvention;
			case 866287159: // legalEntityId
			  return ((FixedCouponBond) bean).LegalEntityId;
			case 135924714: // settlementDateOffset
			  return ((FixedCouponBond) bean).SettlementDateOffset;
			case 1408037338: // exCouponPeriod
			  return ((FixedCouponBond) bean).ExCouponPeriod;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<FixedCouponBond>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(FixedCouponBond beanToCopy)
		{
		...
		public override FixedCouponBond build()
		{
		  return new FixedCouponBond(securityId_Renamed, currency_Renamed, notional_Renamed, accrualSchedule_Renamed, fixedRate_Renamed, dayCount_Renamed, yieldConvention_Renamed, legalEntityId_Renamed, settlementDateOffset_Renamed, exCouponPeriod_Renamed);
		}
