...
namespace com.opengamma.strata.product.fra
{
	...
	/// <para>
	/// This is the resolved form of <seealso cref="FraTrade"/> and is the primary input to the pricers.
	/// Applications will typically create a {@code ResolvedFraTrade} from a {@code FraTrade}
	/// using <seealso cref="FraTrade#resolve(ReferenceData)"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition public final class ResolvedFraTrade implements com.opengamma.strata.product.ResolvedTrade, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ResolvedFraTrade : ResolvedTrade, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.TradeInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final ResolvedFra product;
	  private readonly ResolvedFra product;
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ResolvedFraTrade}. </summary>
	  ...
	  public override ResolvedFraTrade.Meta metaBean()
	  {
		return ResolvedFraTrade.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(ResolvedFraTrade), typeof(TradeInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(ResolvedFraTrade), typeof(ResolvedFra));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ResolvedFra> product_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ResolvedFraTrade.Builder builder()
		{
		  return new ResolvedFraTrade.Builder();
		}
		...
		{
		  return typeof(ResolvedFraTrade);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((ResolvedFraTrade) bean).Info;
			case -309474065: // product
			  return ((ResolvedFraTrade) bean).Product;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ResolvedFraTrade>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal TradeInfo info_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ResolvedFra product_Renamed;
		...
		public override ResolvedFraTrade build()
		{
		  return new ResolvedFraTrade(info_Renamed, product_Renamed);
		}
