...
namespace com.opengamma.strata.product.swap.type
{
	...
	/// <para>
	/// This defines almost all the data necessary to create a Fixed-Overnight single currency <seealso cref="SwapTrade"/>.
...
//ORIGINAL LINE: @BeanDefinition public final class FixedOvernightSwapTemplate implements com.opengamma.strata.product.TradeTemplate, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FixedOvernightSwapTemplate : TradeTemplate, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.basics.date.Tenor tenor;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final FixedOvernightSwapConvention convention;
	  private readonly FixedOvernightSwapConvention convention;
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FixedOvernightSwapTemplate}. </summary>
	  ...
	  {
		MetaBean.register(FixedOvernightSwapTemplate.Meta.INSTANCE);
	  }
	  ...
	  public override FixedOvernightSwapTemplate.Meta metaBean()
	  {
		return FixedOvernightSwapTemplate.Meta.INSTANCE;
	  }
	  ...
	  /// <returns> the value of the property, not null </returns>
	  public FixedOvernightSwapConvention Convention
	  {
		  get
		  {
			return convention;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  periodToStart_Renamed = DirectMetaProperty.ofImmutable(this, "periodToStart", typeof(FixedOvernightSwapTemplate), typeof(Period));
			  tenor_Renamed = DirectMetaProperty.ofImmutable(this, "tenor", typeof(FixedOvernightSwapTemplate), typeof(Tenor));
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(FixedOvernightSwapTemplate), typeof(FixedOvernightSwapConvention));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<FixedOvernightSwapConvention> convention_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override FixedOvernightSwapTemplate.Builder builder()
		{
		  return new FixedOvernightSwapTemplate.Builder();
		}
		...
		{
		  return typeof(FixedOvernightSwapTemplate);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -574688858: // periodToStart
			  return ((FixedOvernightSwapTemplate) bean).PeriodToStart;
			case 110246592: // tenor
			  return ((FixedOvernightSwapTemplate) bean).Tenor;
			case 2039569265: // convention
			  return ((FixedOvernightSwapTemplate) bean).Convention;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<FixedOvernightSwapTemplate>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal FixedOvernightSwapConvention convention_Renamed;
		...
		public override FixedOvernightSwapTemplate build()
		{
		  return new FixedOvernightSwapTemplate(periodToStart_Renamed, tenor_Renamed, convention_Renamed);
		}
