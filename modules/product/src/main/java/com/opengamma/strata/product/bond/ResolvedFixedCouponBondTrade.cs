...
namespace com.opengamma.strata.product.bond
{
	...
	/// <para>
	/// This is the resolved form of <seealso cref="FixedCouponBondTrade"/> and is the primary input to the pricers.
	/// Applications will typically create a {@code ResolvedFixedCouponBondTrade} from a {@code FixedCouponBondTrade}
	/// using <seealso cref="FixedCouponBondTrade#resolve(ReferenceData)"/>.
	/// </para>
	/// <para>
	/// It is also the resolved form of <seealso cref="FixedCouponBondPosition"/> for those cases where a position is held.
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class ResolvedFixedCouponBondTrade implements com.opengamma.strata.product.ResolvedTrade, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ResolvedFixedCouponBondTrade : ResolvedTrade, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.PortfolioItemInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final ResolvedFixedCouponBond product;
	  private readonly ResolvedFixedCouponBond product;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition private final double quantity;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(get = "optional") private final ResolvedFixedCouponBondSettlement settlement;
	  private readonly ResolvedFixedCouponBondSettlement settlement;
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ResolvedFixedCouponBondTrade}. </summary>
	  ...
	  static ResolvedFixedCouponBondTrade()
	  {
	  ...
	  public override ResolvedFixedCouponBondTrade.Meta metaBean()
	  {
		return ResolvedFixedCouponBondTrade.Meta.INSTANCE;
	  }
	  ...
	  /// </summary>
	  /// <returns> the value of the property, not null </returns>
	  public ResolvedFixedCouponBond Product
	  {
		  get
		  {
			return product;
	  ...
	  public Optional<ResolvedFixedCouponBondSettlement> Settlement
	  {
		  get
		  {
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(ResolvedFixedCouponBondTrade), typeof(PortfolioItemInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(ResolvedFixedCouponBondTrade), typeof(ResolvedFixedCouponBond));
			  quantity_Renamed = DirectMetaProperty.ofImmutable(this, "quantity", typeof(ResolvedFixedCouponBondTrade), Double.TYPE);
			  settlement_Renamed = DirectMetaProperty.ofImmutable(this, "settlement", typeof(ResolvedFixedCouponBondTrade), typeof(ResolvedFixedCouponBondSettlement));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ResolvedFixedCouponBond> product_Renamed;
		/// <summary>
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ResolvedFixedCouponBondSettlement> settlement_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ResolvedFixedCouponBondTrade.Builder builder()
		{
		  return new ResolvedFixedCouponBondTrade.Builder();
		}
		...
		{
		  return typeof(ResolvedFixedCouponBondTrade);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((ResolvedFixedCouponBondTrade) bean).Info;
			case -309474065: // product
			  return ((ResolvedFixedCouponBondTrade) bean).Product;
			case -1285004149: // quantity
			  return ((ResolvedFixedCouponBondTrade) bean).Quantity;
			case 73828649: // settlement
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ResolvedFixedCouponBondTrade>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal PortfolioItemInfo info_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ResolvedFixedCouponBond product_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal double quantity_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ResolvedFixedCouponBondSettlement settlement_Renamed;
		...
		public override ResolvedFixedCouponBondTrade build()
		{
		  return new ResolvedFixedCouponBondTrade(info_Renamed, product_Renamed, quantity_Renamed, settlement_Renamed);
		}
