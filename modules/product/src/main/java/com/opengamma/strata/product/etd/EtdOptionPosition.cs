...
//ORIGINAL LINE: @BeanDefinition public final class EtdOptionPosition implements EtdPosition, com.opengamma.strata.product.ResolvableSecurityPosition, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class EtdOptionPosition : EtdPosition, ResolvableSecurityPosition, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.PositionInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final EtdOptionSecurity security;
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code EtdOptionPosition}. </summary>
	  ...
	  public override EtdOptionPosition.Meta metaBean()
	  {
		return EtdOptionPosition.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(EtdOptionPosition), typeof(PositionInfo));
			  security_Renamed = DirectMetaProperty.ofImmutable(this, "security", typeof(EtdOptionPosition), typeof(EtdOptionSecurity));
			  longQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "longQuantity", typeof(EtdOptionPosition), Double.TYPE);
			  shortQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "shortQuantity", typeof(EtdOptionPosition), Double.TYPE);
			  quantity_Renamed = DirectMetaProperty.ofDerived(this, "quantity", typeof(EtdOptionPosition), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override EtdOptionPosition.Builder builder()
		{
		  return new EtdOptionPosition.Builder();
		}
		...
		{
		  return typeof(EtdOptionPosition);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((EtdOptionPosition) bean).Info;
			case 949122880: // security
			  return ((EtdOptionPosition) bean).Security;
			case 611668775: // longQuantity
			  return ((EtdOptionPosition) bean).LongQuantity;
			case -2094395097: // shortQuantity
			  return ((EtdOptionPosition) bean).ShortQuantity;
			case -1285004149: // quantity
			  return ((EtdOptionPosition) bean).Quantity;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<EtdOptionPosition>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override EtdOptionPosition build()
		{
		  return new EtdOptionPosition(info_Renamed, security_Renamed, longQuantity_Renamed, shortQuantity_Renamed);
		}
