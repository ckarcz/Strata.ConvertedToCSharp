...
namespace com.opengamma.strata.product.bond
{
	...
	/// <para>
	/// A position in an underlying <seealso cref="Bill"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class BillPosition implements com.opengamma.strata.product.SecuritizedProductPosition<Bill>, com.opengamma.strata.basics.Resolvable<ResolvedBillTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class BillPosition : SecuritizedProductPosition<Bill>, Resolvable<ResolvedBillTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "ArgChecker.notNegative") private final double shortQuantity;
	  ...
	  public static BillPosition ofNet(PositionInfo positionInfo, Bill product, double netQuantity)
	  {
		double longQuantity = netQuantity >= 0 ? netQuantity : 0;
		double shortQuantity = netQuantity >= 0 ? 0 : -netQuantity;
		return new BillPosition(positionInfo, product, longQuantity, shortQuantity);
	  }
	  ...
	  /// <returns> the position </returns>
	  public static BillPosition ofLongShort(PositionInfo positionInfo, Bill product, double longQuantity, double shortQuantity)
	  {
...
//ORIGINAL LINE: @Override @DerivedProperty public double getQuantity()
	  ...
	  public BillPosition withQuantity(double quantity)
	  {
		return BillPosition.ofNet(info, product, quantity);
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code BillPosition}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static BillPosition.Meta meta()
	  {
		return BillPosition.Meta.INSTANCE;
	  }

	  static BillPosition()
	  {
		MetaBean.register(BillPosition.Meta.INSTANCE);
	  }
	  ...
	  public static BillPosition.Builder builder()
	  {
		return new BillPosition.Builder();
	  }
	  ...
	  internal BillPosition(PositionInfo info, Bill product, double longQuantity, double shortQuantity)
	  {
	  ...
	  public override BillPosition.Meta metaBean()
	  {
		return BillPosition.Meta.INSTANCE;
	  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The meta-bean for {@code BillPosition}.
	  /// </summary>
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(BillPosition), typeof(PositionInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(BillPosition), typeof(Bill));
			  longQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "longQuantity", typeof(BillPosition), Double.TYPE);
			  shortQuantity_Renamed = DirectMetaProperty.ofImmutable(this, "shortQuantity", typeof(BillPosition), Double.TYPE);
			  quantity_Renamed = DirectMetaProperty.ofDerived(this, "quantity", typeof(BillPosition), Double.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override BillPosition.Builder builder()
		{
		  return new BillPosition.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((BillPosition) bean).Info;
			case -309474065: // product
			  return ((BillPosition) bean).Product;
			case 611668775: // longQuantity
			  return ((BillPosition) bean).LongQuantity;
			case -2094395097: // shortQuantity
			  return ((BillPosition) bean).ShortQuantity;
			case -1285004149: // quantity
			  return ((BillPosition) bean).Quantity;
		  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The bean-builder for {@code BillPosition}.
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<BillPosition>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(BillPosition beanToCopy)
		{
		...
		public override BillPosition build()
		{
		  return new BillPosition(info_Renamed, product_Renamed, longQuantity_Renamed, shortQuantity_Renamed);
		}
		...
		{
		  StringBuilder buf = new StringBuilder(160);
		  buf.Append("BillPosition.Builder{");
