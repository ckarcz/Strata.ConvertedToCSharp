...
//ORIGINAL LINE: @BeanDefinition public final class KnownAmountSwapPaymentPeriod implements SwapPaymentPeriod, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class KnownAmountSwapPaymentPeriod : SwapPaymentPeriod, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code KnownAmountSwapPaymentPeriod}. </summary>
	  ...
	  static KnownAmountSwapPaymentPeriod()
	  {
		MetaBean.register(KnownAmountSwapPaymentPeriod.Meta.INSTANCE);
	  }
	  ...
	  private KnownAmountSwapPaymentPeriod(Payment payment, LocalDate startDate, LocalDate endDate, LocalDate unadjustedStartDate, LocalDate unadjustedEndDate)
	  {
	  ...
	  public override KnownAmountSwapPaymentPeriod.Meta metaBean()
	  {
		return KnownAmountSwapPaymentPeriod.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  payment_Renamed = DirectMetaProperty.ofImmutable(this, "payment", typeof(KnownAmountSwapPaymentPeriod), typeof(Payment));
			  startDate_Renamed = DirectMetaProperty.ofImmutable(this, "startDate", typeof(KnownAmountSwapPaymentPeriod), typeof(LocalDate));
			  endDate_Renamed = DirectMetaProperty.ofImmutable(this, "endDate", typeof(KnownAmountSwapPaymentPeriod), typeof(LocalDate));
			  unadjustedStartDate_Renamed = DirectMetaProperty.ofImmutable(this, "unadjustedStartDate", typeof(KnownAmountSwapPaymentPeriod), typeof(LocalDate));
			  unadjustedEndDate_Renamed = DirectMetaProperty.ofImmutable(this, "unadjustedEndDate", typeof(KnownAmountSwapPaymentPeriod), typeof(LocalDate));
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override KnownAmountSwapPaymentPeriod.Builder builder()
		{
		  return new KnownAmountSwapPaymentPeriod.Builder();
		}
		...
		{
		  return typeof(KnownAmountSwapPaymentPeriod);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -786681338: // payment
			  return ((KnownAmountSwapPaymentPeriod) bean).Payment;
			case -2129778896: // startDate
			  return ((KnownAmountSwapPaymentPeriod) bean).StartDate;
			case -1607727319: // endDate
			  return ((KnownAmountSwapPaymentPeriod) bean).EndDate;
			case 1457691881: // unadjustedStartDate
			  return ((KnownAmountSwapPaymentPeriod) bean).UnadjustedStartDate;
			case 31758114: // unadjustedEndDate
			  return ((KnownAmountSwapPaymentPeriod) bean).UnadjustedEndDate;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<KnownAmountSwapPaymentPeriod>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(KnownAmountSwapPaymentPeriod beanToCopy)
		{
		...
		public override KnownAmountSwapPaymentPeriod build()
		{
		  preBuild(this);
		  return new KnownAmountSwapPaymentPeriod(payment_Renamed, startDate_Renamed, endDate_Renamed, unadjustedStartDate_Renamed, unadjustedEndDate_Renamed);
		}
