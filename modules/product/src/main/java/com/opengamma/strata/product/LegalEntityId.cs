...
namespace com.opengamma.strata.product
{
	...
	/// <para>
	/// This identifier is used to obtain a <seealso cref="LegalEntity"/> from <seealso cref="ReferenceData"/>.
	/// </para>
	/// <para>
	...
	/// </summary>
	[Serializable]
	public sealed class LegalEntityId : ReferenceDataId<LegalEntity>
	{
...
//ORIGINAL LINE: @FromString public static LegalEntityId parse(String str)
	  ...
	  public Type<LegalEntity> ReferenceDataType
	  {
		  get
		  {
			return typeof(LegalEntity);
		  }
	  }
