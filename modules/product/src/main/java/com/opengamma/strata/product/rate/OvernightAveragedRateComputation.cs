...
//ORIGINAL LINE: @BeanDefinition public final class OvernightAveragedRateComputation implements OvernightRateComputation, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class OvernightAveragedRateComputation : OvernightRateComputation, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableValidator private void validate()
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code OvernightAveragedRateComputation}. </summary>
	  ...
	  {
		MetaBean.register(OvernightAveragedRateComputation.Meta.INSTANCE);
	  }
	  ...
	  public override OvernightAveragedRateComputation.Meta metaBean()
	  {
		return OvernightAveragedRateComputation.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  index_Renamed = DirectMetaProperty.ofImmutable(this, "index", typeof(OvernightAveragedRateComputation), typeof(OvernightIndex));
			  fixingCalendar_Renamed = DirectMetaProperty.ofImmutable(this, "fixingCalendar", typeof(OvernightAveragedRateComputation), typeof(HolidayCalendar));
			  startDate_Renamed = DirectMetaProperty.ofImmutable(this, "startDate", typeof(OvernightAveragedRateComputation), typeof(LocalDate));
			  endDate_Renamed = DirectMetaProperty.ofImmutable(this, "endDate", typeof(OvernightAveragedRateComputation), typeof(LocalDate));
			  rateCutOffDays_Renamed = DirectMetaProperty.ofImmutable(this, "rateCutOffDays", typeof(OvernightAveragedRateComputation), Integer.TYPE);
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override OvernightAveragedRateComputation.Builder builder()
		{
		  return new OvernightAveragedRateComputation.Builder();
		}
		...
		{
		  return typeof(OvernightAveragedRateComputation);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 100346066: // index
			  return ((OvernightAveragedRateComputation) bean).Index;
			case 394230283: // fixingCalendar
			  return ((OvernightAveragedRateComputation) bean).FixingCalendar;
			case -2129778896: // startDate
			  return ((OvernightAveragedRateComputation) bean).StartDate;
			case -1607727319: // endDate
			  return ((OvernightAveragedRateComputation) bean).EndDate;
			case -92095804: // rateCutOffDays
			  return ((OvernightAveragedRateComputation) bean).RateCutOffDays;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<OvernightAveragedRateComputation>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(OvernightAveragedRateComputation beanToCopy)
		{
		...
		public override OvernightAveragedRateComputation build()
		{
		  return new OvernightAveragedRateComputation(index_Renamed, fixingCalendar_Renamed, startDate_Renamed, endDate_Renamed, rateCutOffDays_Renamed);
		}
