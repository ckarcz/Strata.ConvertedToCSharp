...
namespace com.opengamma.strata.product.fx
{
	...
	/// <para>
	/// An Over-The-Counter (OTC) trade in an <seealso cref="FxSingle"/>.
	/// </para>
	/// <para>
...
//ORIGINAL LINE: @BeanDefinition public final class FxSingleTrade implements FxTrade, com.opengamma.strata.product.ResolvableTrade<ResolvedFxSingleTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FxSingleTrade : FxTrade, ResolvableTrade<ResolvedFxSingleTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.product.TradeInfo info;
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final FxSingle product;
	  private readonly FxSingle product;
...
//ORIGINAL LINE: @ImmutableDefaults private static void applyDefaults(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FxSingleTrade}. </summary>
	  ...
	  public override FxSingleTrade.Meta metaBean()
	  {
		return FxSingleTrade.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  info_Renamed = DirectMetaProperty.ofImmutable(this, "info", typeof(FxSingleTrade), typeof(TradeInfo));
			  product_Renamed = DirectMetaProperty.ofImmutable(this, "product", typeof(FxSingleTrade), typeof(FxSingle));
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<FxSingle> product_Renamed;
		/// <summary>
		/// The meta-properties.
		/// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override FxSingleTrade.Builder builder()
		{
		  return new FxSingleTrade.Builder();
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((FxSingleTrade) bean).Info;
			case -309474065: // product
			  return ((FxSingleTrade) bean).Product;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<FxSingleTrade>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal TradeInfo info_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal FxSingle product_Renamed;
		...
		public override FxSingleTrade build()
		{
		  return new FxSingleTrade(info_Renamed, product_Renamed);
		}
