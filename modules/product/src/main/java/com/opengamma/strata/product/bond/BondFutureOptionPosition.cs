...
namespace com.opengamma.strata.product.bond
{
	...
	/// <para>
	/// A position in an underlying <seealso cref="BondFutureOption"/>.
	/// </para>
	/// <para>
	...
	/// This is coherent with the pricing of <seealso cref="BondFutureOption"/>.
	/// </para>
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @BeanDefinition(constructorScope = "package") public final class BondFutureOptionPosition implements com.opengamma.strata.product.SecuritizedProductPosition<BondFutureOption>, com.opengamma.strata.basics.Resolvable<ResolvedBondFutureOptionTrade>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class BondFutureOptionPosition : SecuritizedProductPosition<BondFutureOption>, Resolvable<ResolvedBondFutureOptionTrade>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "ArgChecker.notNegative") private final double shortQuantity;
	  ...
	  public static BondFutureOptionPosition ofNet(PositionInfo positionInfo, BondFutureOption product, double netQuantity)
	  {
		double longQuantity = netQuantity >= 0 ? netQuantity : 0;
		double shortQuantity = netQuantity >= 0 ? 0 : -netQuantity;
		return new BondFutureOptionPosition(positionInfo, product, longQuantity, shortQuantity);
	  }
	  ...
	  /// <returns> the position </returns>
	  public static BondFutureOptionPosition ofLongShort(PositionInfo positionInfo, BondFutureOption product, double longQuantity, double shortQuantity)
	  {
...
//ORIGINAL LINE: @Override @DerivedProperty public double getQuantity()
	  ...
	  public BondFutureOptionPosition withQuantity(double quantity)
	  {
		return BondFutureOptionPosition.ofNet(info, product, quantity);
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code BondFutureOptionPosition}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static BondFutureOptionPosition.Meta meta()
	  {
		return BondFutureOptionPosition.Meta.INSTANCE;
	  }

	  static BondFutureOptionPosition()
	  {
		MetaBean.register(BondFutureOptionPosition.Meta.INSTANCE);
	  }
	  ...
	  public static BondFutureOptionPosition.Builder builder()
	  {
		return new BondFutureOptionPosition.Builder();
	  }
	  ...
	  internal BondFutureOptionPosition(PositionInfo info, BondFutureOption product, double longQuantity, double shortQuantity)
	  {
	  ...
	  public override BondFutureOptionPosition.Meta metaBean()
	  {
		return BondFutureOptionPosition.Meta.INSTANCE;
	  }
	  ...
	  public override bool Equals(object obj)
	  {
		...
		{
		  BondFutureOptionPosition other = (BondFutureOptionPosition) obj;
	  ...
	  public override string ToString()
	  {
		...
		buf.Append("BondFutureOptionPosition{");
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The meta-bean for {@code BondFutureOptionPosition}.
	  /// </summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override BondFutureOptionPosition.Builder builder()
		{
		  return new BondFutureOptionPosition.Builder();
		}
		...
		{
		  return typeof(BondFutureOptionPosition);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 3237038: // info
			  return ((BondFutureOptionPosition) bean).Info;
			case -309474065: // product
			  return ((BondFutureOptionPosition) bean).Product;
			case 611668775: // longQuantity
			  return ((BondFutureOptionPosition) bean).LongQuantity;
			case -2094395097: // shortQuantity
			  return ((BondFutureOptionPosition) bean).ShortQuantity;
			case -1285004149: // quantity
			  return ((BondFutureOptionPosition) bean).Quantity;
		  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// The bean-builder for {@code BondFutureOptionPosition}.
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<BondFutureOptionPosition>
	  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override BondFutureOptionPosition build()
		{
		  return new BondFutureOptionPosition(info_Renamed, product_Renamed, longQuantity_Renamed, shortQuantity_Renamed);
		}
		...
		{
		  StringBuilder buf = new StringBuilder(160);
		  buf.Append("BondFutureOptionPosition.Builder{");
