...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="ResolvedBondFutureOption"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class ResolvedBondFutureOptionTest
	public class ResolvedBondFutureOptionTest
	{
	  ...
	  //-------------------------------------------------------------------------
	  internal static ResolvedBondFutureOption sut()
	  {
		return BondFutureOptionTest.sut().resolve(REF_DATA);
	  }

	  internal static ResolvedBondFutureOption sut2()
	  {
