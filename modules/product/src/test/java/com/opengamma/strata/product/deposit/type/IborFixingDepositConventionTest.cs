...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="IborFixingDepositConvention"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class IborFixingDepositConventionTest
	public class IborFixingDepositConventionTest
	{
	  ...
	  private static readonly DaysAdjustment SPOT_ADJ = DaysAdjustment.ofBusinessDays(2, EUTA);
	  private static readonly DaysAdjustment FIXING_ADJ = DaysAdjustment.ofBusinessDays(-2, EUTA, BusinessDayAdjustment.of(PRECEDING, GBLO));
	  ...
	  public virtual void test_builder_indexOnly()
	  {
		ImmutableIborFixingDepositConvention test = ImmutableIborFixingDepositConvention.builder().index(GBP_LIBOR_6M).build();
