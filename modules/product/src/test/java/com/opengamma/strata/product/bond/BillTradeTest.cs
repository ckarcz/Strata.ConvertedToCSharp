...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="BillTrade"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class BillTradeTest
	public class BillTradeTest
	{
	  ...
	  private const double YIELD = 0.0123;
	  private const double PRICE = 0.9877;
	  private const double PRICE2 = 0.975;
	  private static readonly Bill PRODUCT = BillTest.US_BILL;
	  ...
	  public virtual void test_ofPrice()
	  {
