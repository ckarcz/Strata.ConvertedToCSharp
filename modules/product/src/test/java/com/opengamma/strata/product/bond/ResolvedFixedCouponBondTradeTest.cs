...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="ResolvedFixedCouponBondTrade"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class ResolvedFixedCouponBondTradeTest
	public class ResolvedFixedCouponBondTradeTest
	{
	  ...
	  //-------------------------------------------------------------------------
	  internal static ResolvedFixedCouponBondTrade sut()
	  {
		return FixedCouponBondTradeTest.sut().resolve(REF_DATA);
	  }

	  internal static ResolvedFixedCouponBondTrade sut2()
	  {
