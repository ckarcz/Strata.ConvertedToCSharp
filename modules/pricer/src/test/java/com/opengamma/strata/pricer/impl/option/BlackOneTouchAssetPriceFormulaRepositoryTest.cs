...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="BlackOneTouchAssetPriceFormulaRepository"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class BlackOneTouchAssetPriceFormulaRepositoryTest
	public class BlackOneTouchAssetPriceFormulaRepositoryTest
	{
	  ...
	  private static readonly BlackOneTouchAssetPriceFormulaRepository PRICER = new BlackOneTouchAssetPriceFormulaRepository();
	  ...
	  public virtual void smallsigmaTTest()
	  {
		foreach (SimpleConstantContinuousBarrier barrier in BARRIERS)
		{
		  ...
		  assertRelative(optUpAdj.Value, optDwAdj.Value, 1.0e-3);
		  for (int i = 0; i < 6; ++i)
		  {
