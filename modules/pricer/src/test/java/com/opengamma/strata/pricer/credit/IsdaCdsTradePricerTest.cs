...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="IsdaCdsTradePricer"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class IsdaCdsTradePricerTest
	public class IsdaCdsTradePricerTest
	{
	  ...
	  private static readonly ResolvedCds PRODUCT = Cds.of(BUY, LEGAL_ENTITY, USD, NOTIONAL, LocalDate.of(2013, 12, 20), LocalDate.of(2020, 10, 20), Frequency.P3M, CALENDAR, 0.015).resolve(REF_DATA);
	  ...
	  private static readonly ResolvedCdsTrade TRADE = ResolvedCdsTrade.builder().product(PRODUCT).info(TRADE_INFO).upfrontFee(UPFRONT).build();
	  private static readonly ResolvedCdsTrade TRADE_NO_SETTLE_DATE = ResolvedCdsTrade.builder().product(PRODUCT).info(TradeInfo.of(VALUATION_DATE)).build();

	  private static readonly IsdaCdsTradePricer PRICER = IsdaCdsTradePricer.DEFAULT;
	  private static readonly IsdaCdsTradePricer PRICER_MF = new IsdaCdsTradePricer(AccrualOnDefaultFormula.MARKIT_FIX);
	  private static readonly IsdaCdsProductPricer PRICER_PRODUCT = IsdaCdsProductPricer.DEFAULT;
	  private static readonly IsdaCdsProductPricer PRICER_PRODUCT_MF = new IsdaCdsProductPricer(AccrualOnDefaultFormula.MARKIT_FIX);
	  ...
	  public virtual void accFormulaTest()
	  {
		...
		assertEquals(PRICER_MF.AccrualOnDefaultFormula, AccrualOnDefaultFormula.MARKIT_FIX);
	  }
	  ...
	  public virtual void test_priceWithCoupon()
	  {
		double coupon = 0.015;
