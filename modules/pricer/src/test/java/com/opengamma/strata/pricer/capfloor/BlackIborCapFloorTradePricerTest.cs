...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="BlackIborCapFloorTradePricer"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class BlackIborCapFloorTradePricerTest
	public class BlackIborCapFloorTradePricerTest
	{
	  ...
	  private static readonly BlackIborCapletFloorletExpiryStrikeVolatilities VOLS = IborCapletFloorletDataSet.createBlackVolatilities(VALUATION, EUR_EURIBOR_6M);
	  ...
	  private static readonly BlackIborCapFloorTradePricer PRICER = BlackIborCapFloorTradePricer.DEFAULT;
	  private static readonly BlackIborCapFloorProductPricer PRICER_PRODUCT = BlackIborCapFloorProductPricer.DEFAULT;
