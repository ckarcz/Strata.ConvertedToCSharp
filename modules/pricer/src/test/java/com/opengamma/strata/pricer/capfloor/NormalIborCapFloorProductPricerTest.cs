...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NormalIborCapFloorProductPricer"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NormalIborCapFloorProductPricerTest
	public class NormalIborCapFloorProductPricerTest
	{
	  ...
	  private static readonly ResolvedSwapLeg PAY_LEG = IborCapFloorDataSet.createFixedPayLeg(EUR_EURIBOR_6M, START, END, 0.002, NOTIONAL_VALUE, PAY);
	  ...
	  private static readonly NormalIborCapFloorProductPricer PRICER = NormalIborCapFloorProductPricer.DEFAULT;
	  private static readonly NormalIborCapFloorLegPricer PRICER_CAP_LEG = NormalIborCapFloorLegPricer.DEFAULT;
