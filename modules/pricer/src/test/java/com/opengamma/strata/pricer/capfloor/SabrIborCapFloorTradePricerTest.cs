...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="SabrIborCapFloorTradePricer"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class SabrIborCapFloorTradePricerTest
	public class SabrIborCapFloorTradePricerTest
	{
	  ...
	  private static readonly ImmutableRatesProvider RATES = IborCapletFloorletSabrRateVolatilityDataSet.getRatesProvider(VALUATION.toLocalDate(), EUR_EURIBOR_6M, LocalDateDoubleTimeSeries.empty());
	  private static readonly SabrIborCapletFloorletVolatilities VOLS = IborCapletFloorletSabrRateVolatilityDataSet.getVolatilities(VALUATION, EUR_EURIBOR_6M);
	  ...
	  private static readonly ImmutableRatesProvider RATES_PAY = IborCapletFloorletSabrRateVolatilityDataSet.getRatesProvider(VALUATION_PAY.toLocalDate(), EUR_EURIBOR_6M, TIME_SERIES);
	  private static readonly SabrIborCapletFloorletVolatilities VOLS_PAY = IborCapletFloorletSabrRateVolatilityDataSet.getVolatilities(VALUATION_PAY, EUR_EURIBOR_6M);

	  private const double TOL = 1.0e-13;
	  private static readonly SabrIborCapFloorTradePricer PRICER = SabrIborCapFloorTradePricer.DEFAULT;
	  private static readonly SabrIborCapFloorProductPricer PRICER_PRODUCT = SabrIborCapFloorProductPricer.DEFAULT;
