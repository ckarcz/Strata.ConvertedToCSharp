...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NormalSwaptionExpirySimpleMoneynessVolatilities"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NormalSwaptionExpirySimpleMoneynessVolatilitiesTest
	public class NormalSwaptionExpirySimpleMoneynessVolatilitiesTest
	{
	  ...
	  private static readonly DoubleArray SIMPLE_MONEYNESS = DoubleArray.of(-0.025, -0.01, 0, 0.01, -0.025, -0.01, 0, 0.01, -0.025, -0.01, 0, 0.01);
	  ...
	  private static readonly InterpolatedNodalSurface SURFACE = InterpolatedNodalSurface.of(METADATA, TIME, SIMPLE_MONEYNESS, VOL, INTERPOLATOR_2D);
	  ...
	  private static readonly NormalSwaptionExpirySimpleMoneynessVolatilities VOLS = NormalSwaptionExpirySimpleMoneynessVolatilities.of(CONVENTION, VAL_DATE_TIME, SURFACE);
	  ...
	  private static readonly double[] TEST_FORWARD = new double[] {0.03, 0.03, 0.04, 0.05};
