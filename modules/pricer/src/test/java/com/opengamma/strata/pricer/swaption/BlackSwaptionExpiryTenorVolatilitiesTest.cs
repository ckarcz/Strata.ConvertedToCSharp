...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="BlackSwaptionExpiryTenorVolatilities"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class BlackSwaptionExpiryTenorVolatilitiesTest
	public class BlackSwaptionExpiryTenorVolatilitiesTest
	{
	  ...
	  private static readonly DoubleArray TENOR = DoubleArray.of(3.0, 5.0, 7.0, 10.0, 3.0, 5.0, 7.0, 10.0, 3.0, 5.0, 7.0, 10.0);
	  ...
	  private static readonly BlackSwaptionExpiryTenorVolatilities VOLS = BlackSwaptionExpiryTenorVolatilities.of(CONVENTION, VAL_DATE_TIME, SURFACE);
	  ...
	  private static readonly double[] TEST_SENSITIVITY = new double[] {1.0, 2.0, 1.2, -1.0};
