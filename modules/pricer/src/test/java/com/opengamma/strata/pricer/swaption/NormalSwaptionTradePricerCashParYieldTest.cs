...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="NormalSwaptionTradePricer"/> for cash par yield.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NormalSwaptionTradePricerCashParYieldTest
	public class NormalSwaptionTradePricerCashParYieldTest
	{
	  ...
	  private static readonly NormalSwaptionCashParYieldProductPricer PRICER_PRODUCT = NormalSwaptionCashParYieldProductPricer.DEFAULT;
