...
//	import static org.testng.Assert.assertSame;
	...
	/// <summary>
	/// Test <seealso cref="IborRateSensitivity"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class IborRateSensitivityTest
	public class IborRateSensitivityTest
	{
	  ...
	  private static readonly IborIndexObservation GBP_LIBOR_3M_OBSERVATION = IborIndexObservation.of(GBP_LIBOR_3M, DATE, REF_DATA);
	  private static readonly IborIndexObservation GBP_LIBOR_3M_OBSERVATION2 = IborIndexObservation.of(GBP_LIBOR_3M, DATE2, REF_DATA);
