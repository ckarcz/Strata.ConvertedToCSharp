...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NormalIborCapletFloorletExpiryStrikeVolatilities"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NormalIborCapletFloorletExpiryStrikeVolatilitiesTest
	public class NormalIborCapletFloorletExpiryStrikeVolatilitiesTest
	{

	  private const string NAME = "CAP_VOL";
	  ...
	  private static readonly DoubleArray STRIKE = DoubleArray.of(-0.015, 0.0, 0.01, 0.025, -0.015, 0.0, 0.01, 0.025, -0.015, 0.0, 0.01, 0.025);
	  ...
	  static NormalIborCapletFloorletExpiryStrikeVolatilitiesTest()
	  {
	  ...
	  private static readonly NormalIborCapletFloorletExpiryStrikeVolatilities VOLS = NormalIborCapletFloorletExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, SURFACE);
	  ...
	  private static readonly double[] TEST_STRIKE = new double[] {-0.02, 0.0, 0.019, 0.032};
	  private static readonly double[] TEST_SENSITIVITY = new double[] {1.0, 12.0, -41.0, -2.0};
