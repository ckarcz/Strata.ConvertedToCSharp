...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="SabrSwaptionTradePricer"/> for physical.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class SabrSwaptionPhysicalTradePricerTest
	public class SabrSwaptionPhysicalTradePricerTest
	{
	  ...
	  private static readonly ResolvedSwaption SWAPTION_LONG_REC = Swaption.builder().expiryDate(AdjustableDate.of(MATURITY_DATE.toLocalDate())).expiryTime(MATURITY_DATE.toLocalTime()).expiryZone(MATURITY_DATE.Zone).longShort(LongShort.LONG).swaptionSettlement(PHYSICAL_SETTLE).underlying(SWAP_REC).build().resolve(REF_DATA);
	  ...
	  private static readonly SabrSwaptionPhysicalProductPricer PRICER_PRODUCT = SabrSwaptionPhysicalProductPricer.DEFAULT;
