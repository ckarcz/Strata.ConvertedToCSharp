...
//	import static com.opengamma.strata.basics.index.PriceIndices.US_CPI_U;
	...
	public class CapitalIndexedBondCurveDataSet
	{
	  ...
	  public static readonly LegalEntityId ISSUER_ID = LegalEntityId.of("OG-Ticker", "GOVT");
	  public static readonly LegalEntityGroup GROUP_ISSUER = LegalEntityGroup.of("GOVT");
	  public static readonly RepoGroup GROUP_REPO = RepoGroup.of("GOVT BONDS");
	  ...
	  public static readonly InterpolatedNodalCurve ISSUER_CURVE;
	  public static readonly InterpolatedNodalCurve REPO_CURVE;
	  public static readonly InterpolatedNodalCurve CPI_CURVE;
	  private static readonly InterpolatedNodalCurve RPI_CURVE;
	  private static readonly InterpolatedNodalCurve CPIJ_CURVE;
	  ...
	  {
		return ImmutableRatesProvider.builder(valuationDate).fxRateProvider(FxMatrix.empty()).priceIndexCurve(GB_RPI, RPI_CURVE).timeSeries(GB_RPI, timeSeries).build();
	  }
	  ...
	  {
		return ImmutableRatesProvider.builder(valuationDate).fxRateProvider(FxMatrix.empty()).priceIndexCurve(JP_CPI_EXF, CPIJ_CURVE).timeSeries(JP_CPI_EXF, timeSeries).build();
	  }
	  ...
	  public static LegalEntityDiscountingProvider getLegalEntityDiscountingProvider(LocalDate valuationDate)
	  {
		...
		return ImmutableLegalEntityDiscountingProvider.builder().issuerCurves(ImmutableMap.of(Pair.of(GROUP_ISSUER, USD), dscIssuer)).issuerCurveGroups(ImmutableMap.of(ISSUER_ID, GROUP_ISSUER)).repoCurves(ImmutableMap.of(Pair.of(GROUP_REPO, USD), dscRepo)).repoCurveGroups(ImmutableMap.of(ISSUER_ID, GROUP_REPO)).build();
	  }
	  ...
	  public static LegalEntityDiscountingProvider getLegalEntityDiscountingProviderGb(LocalDate valuationDate)
	  {
		...
		return ImmutableLegalEntityDiscountingProvider.builder().issuerCurves(ImmutableMap.of(Pair.of(GROUP_ISSUER, GBP), dscIssuer)).issuerCurveGroups(ImmutableMap.of(ISSUER_ID, GROUP_ISSUER)).repoCurves(ImmutableMap.of(Pair.of(GROUP_REPO, GBP), dscRepo)).repoCurveGroups(ImmutableMap.of(ISSUER_ID, GROUP_REPO)).build();
	  }
	  ...
	  public static LegalEntityId IssuerId
	  {
		  get
		  {
			return ISSUER_ID;
