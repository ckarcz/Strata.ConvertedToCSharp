...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="BlackIborCapFloorLegPricer"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class BlackIborCapFloorLegPricerTest
	public class BlackIborCapFloorLegPricerTest
	{
	  ...
	  private static readonly BlackIborCapletFloorletExpiryStrikeVolatilities VOLS_AFTER = IborCapletFloorletDataSet.createBlackVolatilities(VALUATION_AFTER, EUR_EURIBOR_3M);
	  ...
	  private static readonly BlackIborCapletFloorletExpiryStrikeVolatilities VOLS_PAY = IborCapletFloorletDataSet.createBlackVolatilities(VALUATION_PAY, EUR_EURIBOR_3M);

	  private const double TOL = 1.0e-14;
	  private static readonly BlackIborCapFloorLegPricer PRICER = BlackIborCapFloorLegPricer.DEFAULT;
	  private static readonly BlackIborCapletFloorletPeriodPricer PRICER_PERIOD = BlackIborCapletFloorletPeriodPricer.DEFAULT;
