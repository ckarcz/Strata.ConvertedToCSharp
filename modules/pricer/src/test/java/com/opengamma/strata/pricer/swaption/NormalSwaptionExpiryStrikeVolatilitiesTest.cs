...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NormalSwaptionExpiryStrikeVolatilities"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NormalSwaptionExpiryStrikeVolatilitiesTest
	public class NormalSwaptionExpiryStrikeVolatilitiesTest
	{
	  ...
	  private static readonly DoubleArray STRIKE = DoubleArray.of(0.025, 0.03, 0.035, 0.04, 0.025, 0.03, 0.035, 0.04, 0.025, 0.03, 0.035, 0.04);
	  ...
	  private static readonly NormalSwaptionExpiryStrikeVolatilities VOLS = NormalSwaptionExpiryStrikeVolatilities.of(CONVENTION, VAL_DATE_TIME, SURFACE);
	  ...
	  private static readonly double[] TEST_STRIKE = new double[] {0.025, 0.035, 0.04, 0.06};
	  private static readonly double[] TEST_SENSITIVITY = new double[] {1.0, 1.0, 1.0, 1.0};
	  private const double TEST_TENOR = 2.0; // not used internally
	  private const double TEST_FORWARD = 0.033; // not used internally
	  ...
	  {
		NormalSwaptionExpiryStrikeVolatilities test1 = NormalSwaptionExpiryStrikeVolatilities.of(CONVENTION, VAL_DATE_TIME, SURFACE);
		coverImmutableBean(test1);
		NormalSwaptionExpiryStrikeVolatilities test2 = NormalSwaptionExpiryStrikeVolatilities.of(CONVENTION, VAL_DATE.atStartOfDay(ZoneOffset.UTC), SURFACE);
