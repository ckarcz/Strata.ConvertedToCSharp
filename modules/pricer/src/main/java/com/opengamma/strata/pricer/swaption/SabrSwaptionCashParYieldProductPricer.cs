...
//	import static com.opengamma.strata.market.model.SabrParameterType.RHO;
	...
	/// </para>
	/// </summary>
	public class SabrSwaptionCashParYieldProductPricer : VolatilitySwaptionCashParYieldProductPricer
	{

	  /// <summary>
	  /// Default implementation.
	  /// </summary>
	  public new static readonly SabrSwaptionCashParYieldProductPricer DEFAULT = new SabrSwaptionCashParYieldProductPricer(DiscountingSwapProductPricer.DEFAULT);
