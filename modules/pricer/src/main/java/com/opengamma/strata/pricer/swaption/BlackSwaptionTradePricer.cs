...
namespace com.opengamma.strata.pricer.swaption
{
	...
	public class BlackSwaptionTradePricer
	{
	  ...
	  /// </summary>
	  public static readonly BlackSwaptionTradePricer DEFAULT = new BlackSwaptionTradePricer(BlackSwaptionCashParYieldProductPricer.DEFAULT, BlackSwaptionPhysicalProductPricer.DEFAULT, DiscountingPaymentPricer.DEFAULT);

	  /// <summary>
	  /// Pricer for cash par yield.
	  /// </summary>
	  private readonly BlackSwaptionCashParYieldProductPricer cashParYieldPricer;
	  /// <summary>
	  /// Pricer for physical.
	  /// </summary>
	  private readonly BlackSwaptionPhysicalProductPricer physicalPricer;
	  /// <summary>
	  ...
	  public BlackSwaptionTradePricer(BlackSwaptionCashParYieldProductPricer cashParYieldPricer, BlackSwaptionPhysicalProductPricer physicalPricer, DiscountingPaymentPricer paymentPricer)
	  {
	  ...
	  public virtual MultiCurrencyAmount currencyExposure(ResolvedSwaptionTrade trade, RatesProvider ratesProvider, BlackSwaptionVolatilities swaptionVolatilities)
	  {
