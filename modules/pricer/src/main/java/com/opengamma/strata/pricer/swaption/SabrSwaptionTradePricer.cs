...
namespace com.opengamma.strata.pricer.swaption
{
	...
	public class SabrSwaptionTradePricer
	{
	  ...
	  /// </summary>
	  public static readonly SabrSwaptionTradePricer DEFAULT = new SabrSwaptionTradePricer(SabrSwaptionCashParYieldProductPricer.DEFAULT, SabrSwaptionPhysicalProductPricer.DEFAULT, DiscountingPaymentPricer.DEFAULT);

	  /// <summary>
	  /// Pricer for cash par yield.
	  /// </summary>
	  private readonly SabrSwaptionCashParYieldProductPricer cashParYieldPricer;
	  /// <summary>
	  /// Pricer for physical.
	  /// </summary>
	  private readonly SabrSwaptionPhysicalProductPricer physicalPricer;
	  /// <summary>
