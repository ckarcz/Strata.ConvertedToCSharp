...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class BlackIborCapletFloorletExpiryStrikeVolatilities implements BlackIborCapletFloorletVolatilities, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class BlackIborCapletFloorletExpiryStrikeVolatilities : BlackIborCapletFloorletVolatilities, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @ImmutableConstructor private BlackIborCapletFloorletExpiryStrikeVolatilities(com.opengamma.strata.basics.index.IborIndex index, java.time.ZonedDateTime valuationDateTime, com.opengamma.strata.market.surface.Surface surface)
	  private BlackIborCapletFloorletExpiryStrikeVolatilities(IborIndex index, ZonedDateTime valuationDateTime, Surface surface)
	  {
	  ...
	  {
		return new BlackIborCapletFloorletExpiryStrikeVolatilities(index, valuationDateTime, surface.withParameter(parameterIndex, newValue));
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code BlackIborCapletFloorletExpiryStrikeVolatilities}. </summary>
	  ...
	  public override BlackIborCapletFloorletExpiryStrikeVolatilities.Meta metaBean()
	  {
		return BlackIborCapletFloorletExpiryStrikeVolatilities.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  index_Renamed = DirectMetaProperty.ofImmutable(this, "index", typeof(BlackIborCapletFloorletExpiryStrikeVolatilities), typeof(IborIndex));
			  valuationDateTime_Renamed = DirectMetaProperty.ofImmutable(this, "valuationDateTime", typeof(BlackIborCapletFloorletExpiryStrikeVolatilities), typeof(ZonedDateTime));
			  surface_Renamed = DirectMetaProperty.ofImmutable(this, "surface", typeof(BlackIborCapletFloorletExpiryStrikeVolatilities), typeof(Surface));
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends BlackIborCapletFloorletExpiryStrikeVolatilities> builder()
		public override BeanBuilder<BlackIborCapletFloorletExpiryStrikeVolatilities> builder()
		{
		...
		{
		  return typeof(BlackIborCapletFloorletExpiryStrikeVolatilities);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 100346066: // index
			  return ((BlackIborCapletFloorletExpiryStrikeVolatilities) bean).Index;
			case -949589828: // valuationDateTime
			  return ((BlackIborCapletFloorletExpiryStrikeVolatilities) bean).ValuationDateTime;
			case -1853231955: // surface
			  return ((BlackIborCapletFloorletExpiryStrikeVolatilities) bean).Surface;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<BlackIborCapletFloorletExpiryStrikeVolatilities>
	  {
		...
		public override BlackIborCapletFloorletExpiryStrikeVolatilities build()
		{
		  return new BlackIborCapletFloorletExpiryStrikeVolatilities(index, valuationDateTime, surface);
		}
