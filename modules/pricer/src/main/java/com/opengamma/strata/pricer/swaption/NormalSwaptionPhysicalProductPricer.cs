...
namespace com.opengamma.strata.pricer.swaption
{
	...
	/// </para>
	/// </summary>
	public class NormalSwaptionPhysicalProductPricer : VolatilitySwaptionPhysicalProductPricer
	{

	  /// <summary>
	  /// Default implementation.
	  /// </summary>
	  public new static readonly NormalSwaptionPhysicalProductPricer DEFAULT = new NormalSwaptionPhysicalProductPricer(DiscountingSwapProductPricer.DEFAULT);
