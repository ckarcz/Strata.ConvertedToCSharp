...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class NormalSwaptionExpirySimpleMoneynessVolatilities implements NormalSwaptionVolatilities, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class NormalSwaptionExpirySimpleMoneynessVolatilities : NormalSwaptionVolatilities, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.market.surface.Surface surface;
	  ...
	  public static NormalSwaptionExpirySimpleMoneynessVolatilities of(FixedIborSwapConvention convention, ZonedDateTime valuationDateTime, Surface surface)
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @ImmutableConstructor private NormalSwaptionExpirySimpleMoneynessVolatilities(com.opengamma.strata.product.swap.type.FixedIborSwapConvention convention, java.time.ZonedDateTime valuationDateTime, com.opengamma.strata.market.surface.Surface surface)
	  private NormalSwaptionExpirySimpleMoneynessVolatilities(FixedIborSwapConvention convention, ZonedDateTime valuationDateTime, Surface surface)
	  {
	  ...
	  {
		return new NormalSwaptionExpirySimpleMoneynessVolatilities(convention, valuationDateTime, surface.withParameter(parameterIndex, newValue));
	  }

	  public NormalSwaptionExpirySimpleMoneynessVolatilities withPerturbation(ParameterPerturbation perturbation)
	  {
		return new NormalSwaptionExpirySimpleMoneynessVolatilities(convention, valuationDateTime, surface.withPerturbation(perturbation));
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code NormalSwaptionExpirySimpleMoneynessVolatilities}. </summary>
	  ...
	  static NormalSwaptionExpirySimpleMoneynessVolatilities()
	  {
	  ...
	  public override NormalSwaptionExpirySimpleMoneynessVolatilities.Meta metaBean()
	  {
		return NormalSwaptionExpirySimpleMoneynessVolatilities.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(NormalSwaptionExpirySimpleMoneynessVolatilities), typeof(FixedIborSwapConvention));
			  valuationDateTime_Renamed = DirectMetaProperty.ofImmutable(this, "valuationDateTime", typeof(NormalSwaptionExpirySimpleMoneynessVolatilities), typeof(ZonedDateTime));
			  surface_Renamed = DirectMetaProperty.ofImmutable(this, "surface", typeof(NormalSwaptionExpirySimpleMoneynessVolatilities), typeof(Surface));
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends NormalSwaptionExpirySimpleMoneynessVolatilities> builder()
		public override BeanBuilder<NormalSwaptionExpirySimpleMoneynessVolatilities> builder()
		{
		...
		{
		  return typeof(NormalSwaptionExpirySimpleMoneynessVolatilities);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 2039569265: // convention
			  return ((NormalSwaptionExpirySimpleMoneynessVolatilities) bean).Convention;
			case -949589828: // valuationDateTime
			  return ((NormalSwaptionExpirySimpleMoneynessVolatilities) bean).ValuationDateTime;
			case -1853231955: // surface
			  return ((NormalSwaptionExpirySimpleMoneynessVolatilities) bean).Surface;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<NormalSwaptionExpirySimpleMoneynessVolatilities>
	  {
		...
		public override NormalSwaptionExpirySimpleMoneynessVolatilities build()
		{
		  return new NormalSwaptionExpirySimpleMoneynessVolatilities(convention, valuationDateTime, surface);
		}
