...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class NormalSwaptionExpiryTenorVolatilities implements NormalSwaptionVolatilities, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class NormalSwaptionExpiryTenorVolatilities : NormalSwaptionVolatilities, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.market.surface.Surface surface;
	  ...
	  /// <seealso cref="Surfaces#normalVolatilityByExpiryTenor(String, DayCount)"/>.
	  /// 
	  /// </para>
	  /// </summary>
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @ImmutableConstructor private NormalSwaptionExpiryTenorVolatilities(com.opengamma.strata.product.swap.type.FixedIborSwapConvention convention, java.time.ZonedDateTime valuationDateTime, com.opengamma.strata.market.surface.Surface surface)
	  private NormalSwaptionExpiryTenorVolatilities(FixedIborSwapConvention convention, ZonedDateTime valuationDateTime, Surface surface)
	  {
		...
		surface.Metadata.YValueType.checkEquals(ValueType.YEAR_FRACTION, "Incorrect y-value type for Normal volatilities");
	  ...
	  {
		return new NormalSwaptionExpiryTenorVolatilities(convention, valuationDateTime, surface.withParameter(parameterIndex, newValue));
	  }

	  public NormalSwaptionExpiryTenorVolatilities withPerturbation(ParameterPerturbation perturbation)
	  {
		return new NormalSwaptionExpiryTenorVolatilities(convention, valuationDateTime, surface.withPerturbation(perturbation));
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code NormalSwaptionExpiryTenorVolatilities}. </summary>
	  ...
	  {
		MetaBean.register(NormalSwaptionExpiryTenorVolatilities.Meta.INSTANCE);
	  }
	  ...
	  public override NormalSwaptionExpiryTenorVolatilities.Meta metaBean()
	  {
		return NormalSwaptionExpiryTenorVolatilities.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(NormalSwaptionExpiryTenorVolatilities), typeof(FixedIborSwapConvention));
			  valuationDateTime_Renamed = DirectMetaProperty.ofImmutable(this, "valuationDateTime", typeof(NormalSwaptionExpiryTenorVolatilities), typeof(ZonedDateTime));
			  surface_Renamed = DirectMetaProperty.ofImmutable(this, "surface", typeof(NormalSwaptionExpiryTenorVolatilities), typeof(Surface));
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends NormalSwaptionExpiryTenorVolatilities> builder()
		public override BeanBuilder<NormalSwaptionExpiryTenorVolatilities> builder()
		{
		...
		{
		  return typeof(NormalSwaptionExpiryTenorVolatilities);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 2039569265: // convention
			  return ((NormalSwaptionExpiryTenorVolatilities) bean).Convention;
			case -949589828: // valuationDateTime
			  return ((NormalSwaptionExpiryTenorVolatilities) bean).ValuationDateTime;
			case -1853231955: // surface
			  return ((NormalSwaptionExpiryTenorVolatilities) bean).Surface;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<NormalSwaptionExpiryTenorVolatilities>
	  {
		...
		public override NormalSwaptionExpiryTenorVolatilities build()
		{
		  return new NormalSwaptionExpiryTenorVolatilities(convention, valuationDateTime, surface);
		}
