...
namespace com.opengamma.strata.pricer.impl.tree
{
	...
	/// </para>
	/// </summary>
	internal abstract class SingleBarrierKnockoutFunction : OptionFunction
	{
		public abstract int NumberOfSteps {get;}
		public abstract double TimeToExpiry {get;}

	  /// <summary>
	  /// Obtains strike value.
	  /// </summary>
	  /// <returns> strike </returns>
	  public abstract double Strike {get;}
	  ...
	  public abstract double Sign {get;}

	  /// <summary>
	  /// Obtains the barrier type.
	  /// </summary>
	  /// <returns> the barrier type </returns>
	  public abstract BarrierType BarrierType {get;}

	  /// <summary>
	  /// Obtains the rebate for the time layer specified by {@code step}.
	  /// </summary>
	  /// <param name="step">  the step </param>
	  /// <returns> the rebate </returns>
	  public abstract double getRebate(int step);

	  public virtual DoubleArray getPayoffAtExpiryTrinomial(DoubleArray stateValue)
	  {
	  ...
	  public override DoubleArray getNextOptionValues(double discountFactor, DoubleMatrix transitionProbability, DoubleArray stateValue, DoubleArray values, int i)
	  {
