...
namespace com.opengamma.strata.pricer.fxopt
{
	...
	/// <para>
	/// This function provides the ability to price an <seealso cref="FxVanillaOptionTrade"/>.
	/// </para>
	/// </summary>
	public class BlackFxVanillaOptionTradePricer
	{
	  ...
	  /// </summary>
	  public static readonly BlackFxVanillaOptionTradePricer DEFAULT = new BlackFxVanillaOptionTradePricer(BlackFxVanillaOptionProductPricer.DEFAULT, DiscountingPaymentPricer.DEFAULT);

	  /// <summary>
	  /// Pricer for <seealso cref="ResolvedFxSingleBarrierOption"/>.
	  /// </summary>
	  private readonly BlackFxVanillaOptionProductPricer productPricer;
	  /// <summary>
	  ...
	  public virtual PointSensitivities presentValueSensitivityRatesStickyStrike(ResolvedFxVanillaOptionTrade trade, RatesProvider ratesProvider, BlackFxOptionVolatilities volatilities)
	  {

		ResolvedFxVanillaOption product = trade.Product;
		PointSensitivities pvcsProduct = productPricer.presentValueSensitivityRatesStickyStrike(product, ratesProvider, volatilities);
		Payment premium = trade.Premium;
