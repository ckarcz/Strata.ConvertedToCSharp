...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class BlackSwaptionExpiryTenorVolatilities implements BlackSwaptionVolatilities, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class BlackSwaptionExpiryTenorVolatilities : BlackSwaptionVolatilities, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutableConstructor private BlackSwaptionExpiryTenorVolatilities(com.opengamma.strata.product.swap.type.FixedIborSwapConvention convention, java.time.ZonedDateTime valuationDateTime, com.opengamma.strata.market.surface.Surface surface)
	  ...
	  {
		return new BlackSwaptionExpiryTenorVolatilities(convention, valuationDateTime, surface.withParameter(parameterIndex, newValue));
	  }
	  ...
	  {
		return BlackFormulaRepository.price(forwardRate, strike, expiry, volatility, putCall.Call);
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code BlackSwaptionExpiryTenorVolatilities}. </summary>
	  ...
	  {
		MetaBean.register(BlackSwaptionExpiryTenorVolatilities.Meta.INSTANCE);
	  }
	  ...
	  public override BlackSwaptionExpiryTenorVolatilities.Meta metaBean()
	  {
		return BlackSwaptionExpiryTenorVolatilities.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  convention_Renamed = DirectMetaProperty.ofImmutable(this, "convention", typeof(BlackSwaptionExpiryTenorVolatilities), typeof(FixedIborSwapConvention));
			  valuationDateTime_Renamed = DirectMetaProperty.ofImmutable(this, "valuationDateTime", typeof(BlackSwaptionExpiryTenorVolatilities), typeof(ZonedDateTime));
			  surface_Renamed = DirectMetaProperty.ofImmutable(this, "surface", typeof(BlackSwaptionExpiryTenorVolatilities), typeof(Surface));
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends BlackSwaptionExpiryTenorVolatilities> builder()
		public override BeanBuilder<BlackSwaptionExpiryTenorVolatilities> builder()
		{
		...
		{
		  return typeof(BlackSwaptionExpiryTenorVolatilities);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 2039569265: // convention
			  return ((BlackSwaptionExpiryTenorVolatilities) bean).Convention;
			case -949589828: // valuationDateTime
			  return ((BlackSwaptionExpiryTenorVolatilities) bean).ValuationDateTime;
			case -1853231955: // surface
			  return ((BlackSwaptionExpiryTenorVolatilities) bean).Surface;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<BlackSwaptionExpiryTenorVolatilities>
	  {
		...
		public override BlackSwaptionExpiryTenorVolatilities build()
		{
		  return new BlackSwaptionExpiryTenorVolatilities(convention, valuationDateTime, surface);
		}
