...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class FxOptionSensitivity implements com.opengamma.strata.market.sensitivity.PointSensitivity, com.opengamma.strata.market.sensitivity.PointSensitivityBuilder, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FxOptionSensitivity : PointSensitivity, PointSensitivityBuilder, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final FxOptionVolatilitiesName volatilitiesName;
		private readonly FxOptionVolatilitiesName volatilitiesName;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition(overrideGet = true) private final double sensitivity;
	  ...
	  public override FxOptionSensitivity convertedTo(Currency resultCurrency, FxRateProvider rateProvider)
	  {
		return (FxOptionSensitivity) PointSensitivity.this.convertedTo(resultCurrency, rateProvider);
	  }

	  //-------------------------------------------------------------------------
	  public override FxOptionSensitivity multipliedBy(double factor)
	  {
		return new FxOptionSensitivity(volatilitiesName, currencyPair, expiry, strike, forward, currency, sensitivity * factor);
	  }

	  public FxOptionSensitivity mapSensitivity(System.Func<double, double> @operator)
	  {
		return new FxOptionSensitivity(volatilitiesName, currencyPair, expiry, strike, forward, currency, @operator(sensitivity));
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FxOptionSensitivity}. </summary>
	  ...
	  public override FxOptionSensitivity.Meta metaBean()
	  {
		return FxOptionSensitivity.Meta.INSTANCE;
	  }
	  ...
	  public FxOptionVolatilitiesName VolatilitiesName
	  {
		  get
		  {
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// Gets the currency pair for which the sensitivity is presented. </summary>
	  /// <returns> the value of the property, not null </returns>
	  ...
	  public override bool Equals(object obj)
	  {
		...
		if (obj != null && obj.GetType() == this.GetType())
		{
		  ...
		  return JodaBeanUtils.equal(volatilitiesName, other.volatilitiesName) && JodaBeanUtils.equal(currencyPair, other.currencyPair) && JodaBeanUtils.equal(expiry, other.expiry) && JodaBeanUtils.equal(strike, other.strike) && JodaBeanUtils.equal(forward, other.forward) && JodaBeanUtils.equal(currency, other.currency) && JodaBeanUtils.equal(sensitivity, other.sensitivity);
		}
		return false;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  volatilitiesName_Renamed = DirectMetaProperty.ofImmutable(this, "volatilitiesName", typeof(FxOptionSensitivity), typeof(FxOptionVolatilitiesName));
			  currencyPair_Renamed = DirectMetaProperty.ofImmutable(this, "currencyPair", typeof(FxOptionSensitivity), typeof(CurrencyPair));
			  expiry_Renamed = DirectMetaProperty.ofImmutable(this, "expiry", typeof(FxOptionSensitivity), Double.TYPE);
			  strike_Renamed = DirectMetaProperty.ofImmutable(this, "strike", typeof(FxOptionSensitivity), Double.TYPE);
			  forward_Renamed = DirectMetaProperty.ofImmutable(this, "forward", typeof(FxOptionSensitivity), Double.TYPE);
			  currency_Renamed = DirectMetaProperty.ofImmutable(this, "currency", typeof(FxOptionSensitivity), typeof(Currency));
			  sensitivity_Renamed = DirectMetaProperty.ofImmutable(this, "sensitivity", typeof(FxOptionSensitivity), Double.TYPE);
			  metaPropertyMap$ = new DirectMetaPropertyMap(this, null, "volatilitiesName", "currencyPair", "expiry", "strike", "forward", "currency", "sensitivity");
		  }
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<FxOptionVolatilitiesName> volatilitiesName_Renamed;
		/// <summary>
...
//ORIGINAL LINE: private final java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap$ = new org.joda.beans.impl.direct.DirectMetaPropertyMap(this, null, "volatilitiesName", "currencyPair", "expiry", "strike", "forward", "currency", "sensitivity");
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends FxOptionSensitivity> builder()
		public override BeanBuilder<FxOptionSensitivity> builder()
		{
		...
		{
		  return typeof(FxOptionSensitivity);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 2100884654: // volatilitiesName
			  return ((FxOptionSensitivity) bean).VolatilitiesName;
			case 1005147787: // currencyPair
			  return ((FxOptionSensitivity) bean).CurrencyPair;
			case -1289159373: // expiry
			  return ((FxOptionSensitivity) bean).Expiry;
			case -891985998: // strike
			  return ((FxOptionSensitivity) bean).Strike;
			case -677145915: // forward
			  return ((FxOptionSensitivity) bean).Forward;
			case 575402001: // currency
			  return ((FxOptionSensitivity) bean).Currency;
			case 564403871: // sensitivity
			  return ((FxOptionSensitivity) bean).Sensitivity;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<FxOptionSensitivity>
	  {

		internal FxOptionVolatilitiesName volatilitiesName;
		...
		public override FxOptionSensitivity build()
		{
		  return new FxOptionSensitivity(volatilitiesName, currencyPair, expiry, strike, forward, currency, sensitivity);
		}
