...
//ORIGINAL LINE: public default <V> ObjLongFunction<T, V> andThen(java.util.function.Function<? super R, ? extends V> other)
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//	  public default <V> ObjLongFunction<T, V> andThen(System.Func<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard extends V> other)
	//  {
