...
namespace com.opengamma.strata.collect.function
{
	...
	/// <summary>
	/// A function of two arguments - one object and one {@code int}.
	/// <para>
...
//ORIGINAL LINE: public default <V> ObjIntFunction<T, V> andThen(java.util.function.Function<? super R, ? extends V> other)
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//	  public default <V> ObjIntFunction<T, V> andThen(System.Func<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard extends V> other)
	//  {
