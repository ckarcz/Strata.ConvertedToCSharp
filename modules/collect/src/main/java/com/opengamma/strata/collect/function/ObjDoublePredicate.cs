...
//ORIGINAL LINE: public default ObjDoublePredicate<T> and(ObjDoublePredicate<? super T> other)
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//	  public default ObjDoublePredicate<T> and(ObjDoublePredicate<JavaToDotNetGenericWildcard> other)
	//  {
	...
	//  }
	  ...
	  /// <exception cref="NullPointerException"> if the other predicate is null </exception>
//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
//ORIGINAL LINE: public default ObjDoublePredicate<T> or(ObjDoublePredicate<? super T> other)
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//	  public default ObjDoublePredicate<T> or(ObjDoublePredicate<JavaToDotNetGenericWildcard> other)
	//  {
	//	Objects.requireNonNull(other);
	//	return (obj, value) -> test(obj, value) || other.test(obj, value);
	//  }
