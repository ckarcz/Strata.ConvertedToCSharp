...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="SmithWilsonCurveFunction"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class SmithWilsonCurveFunctionTest
	public class SmithWilsonCurveFunctionTest
	{
	  ...
	  private static readonly ScalarFirstOrderDifferentiator DERIVATIVE = new ScalarFirstOrderDifferentiator(FiniteDifferenceType.CENTRAL, EPS);
	  private static readonly ScalarFieldFirstOrderDifferentiator PARAM_SENSI = new ScalarFieldFirstOrderDifferentiator(FiniteDifferenceType.CENTRAL, EPS);
	  private static readonly SmithWilsonCurveFunction SW_FUNCTION = SmithWilsonCurveFunction.DEFAULT;
	  ...
	  public virtual void test_gap()
	  {
		DoubleArray nodes = DoubleArray.of(3d, 5d, 7d, 10d, 15d, 20d, 30d);
		double testAlpha = 0.05;
		DoubleArray weights = DoubleArray.of(87.2581459896248, -90.049408220743, 16.5225834204242, 20.401521178462, -12.3472386476547, 5.04900954653571, -1.82365099870708);
