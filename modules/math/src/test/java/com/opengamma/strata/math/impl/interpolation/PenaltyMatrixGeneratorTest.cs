...
//ORIGINAL LINE: @Test public class PenaltyMatrixGeneratorTest
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DataProvider public static Object[][] data()
	  public static object[][] data()
	  {
//JAVA TO C# CONVERTER NOTE: The following call to the 'RectangularArrays' helper class reproduces the rectangular array initialization that is automatic in Java:
//ORIGINAL LINE: object[][] obj = new object[1][4];
		object[][] obj = RectangularArrays.ReturnRectangularObjectArray(1, 4);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expectedExceptions = UnsupportedOperationException.class) public void orderG2Test()
	  public virtual void orderG2Test()
	  {
		double[] x = new double[] {0.0, 0.3, 0.7, 0.8, 1.2, 2.0};
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") com.opengamma.strata.collect.array.DoubleMatrix d3 = PenaltyMatrixGenerator.getDerivativeMatrix(x, 3, true);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expectedExceptions = IllegalArgumentException.class) public void xNotUniqueTest()
	  public virtual void xNotUniqueTest()
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expectedExceptions = IllegalArgumentException.class) public void xNotAscendingTest()
	  public virtual void xNotAscendingTest()
	  {
		double[] x = new double[] {0.0, 0.3, 0.8, 0.7, 1.2, 2.0};
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") com.opengamma.strata.collect.array.DoubleMatrix p1 = PenaltyMatrixGenerator.getPenaltyMatrix(x, 2);
		DoubleMatrix p1 = PenaltyMatrixGenerator.getPenaltyMatrix(x, 2);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expectedExceptions = IllegalArgumentException.class) public void emptyXTest()
	  public virtual void emptyXTest()
	  {
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") com.opengamma.strata.collect.array.DoubleMatrix p1 = PenaltyMatrixGenerator.getPenaltyMatrix(new double[0], 1);
