...
//ORIGINAL LINE: @Test public class LognormalFisherKurtosisFromVolatilityCalculatorTest
	public class LognormalFisherKurtosisFromVolatilityCalculatorTest
	{
	  private static readonly System.Func<double, double, double> F = new LognormalFisherKurtosisFromVolatilityCalculator();
