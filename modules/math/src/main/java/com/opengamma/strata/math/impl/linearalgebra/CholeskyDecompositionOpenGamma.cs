...
namespace com.opengamma.strata.math.impl.linearalgebra
{
	...
	/// </summary>
	public class CholeskyDecompositionOpenGamma : Decomposition<CholeskyDecompositionResult>
	{
	  ...
	  /// </summary>
	  public const double DEFAULT_SYMMETRY_THRESHOLD = 1.0E-10;
	  /// <summary>
	  ...
	  /// </summary>
	  public const double DEFAULT_POSITIVITY_THRESHOLD = 1.0E-10;
	  ...
	  /// <summary>
	  /// Perform the decomposition with a given symmetry and positivity threshold. </summary>
	  /// <param name="matrix"> The matrix to decompose. </param>
	  /// <param name="symmetryThreshold"> The symmetry threshold. </param>
	  /// <param name="positivityThreshold"> The positivity threshold. </param>
	  /// <returns> The Cholesky decomposition. </returns>
	  public virtual CholeskyDecompositionResult evaluate(DoubleMatrix matrix, double symmetryThreshold, double positivityThreshold)
	  {
...
//ORIGINAL LINE: double[][] l = new double[nbRow][nbRow];
		double[][] l = RectangularArrays.ReturnRectangularDoubleArray(nbRow, nbRow);
