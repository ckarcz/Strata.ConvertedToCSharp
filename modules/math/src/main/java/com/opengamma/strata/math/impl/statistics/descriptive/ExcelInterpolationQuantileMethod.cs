...
namespace com.opengamma.strata.math.impl.statistics.descriptive
{
	...
	/// </para>
	/// </summary>
	public sealed class ExcelInterpolationQuantileMethod : InterpolationQuantileMethod
	{

	  /// <summary>
	  /// Default implementation. </summary>
	  public static readonly ExcelInterpolationQuantileMethod DEFAULT = new ExcelInterpolationQuantileMethod();
