...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
	  ...
	  /// This method is safer than using (long) Math.ceil(value), because of possible rounding error. </summary>
	  /// <param name="value"> v </param>
	  /// <returns> result </returns>
	  public static long ceil(double value)
	  {
		return (long)Math.Round(Math.Ceiling(value), MidpointRounding.AwayFromZero);
	  }
...
//ORIGINAL LINE: public static double chbevl(double x, double coef[], int N) throws ArithmeticException
	  ...
	  /// <summary>
	  /// Instantly returns the factorial <tt>k!</tt>. </summary>
	  ...
	  /// This method is safer than using (long) Math.floor(value), because of possible rounding error. </summary>
	  /// <param name="value"> v </param>
	  /// <returns> result </returns>
	  public static long floor(double value)
	  {
		return (long)Math.Round(Math.Floor(value), MidpointRounding.AwayFromZero);
	  }

	  /// <summary>
	  /// Returns <tt>log<sub>base</sub>value</tt>. </summary>
	  ...
	  /// <summary>
	  /// Returns <tt>log<sub>10</sub>value</tt>. </summary>
	  /// <param name="value"> v </param>
	  /// <returns> result </returns>
	  ...
	  /// <summary>
	  /// Returns <tt>log<sub>2</sub>value</tt>. </summary>
	  /// <param name="value"> v </param>
	  /// <returns> result </returns>
	  ...
	  /// For <tt>k>=30</tt> uses stirlings approximation. </summary>
	  /// <param name="k"> must hold <tt>k &gt;= 0</tt>. </param>
	  /// <returns> result </returns>
	  public static double logFactorial(int k)
	  {
		...
		{
		  double r, rr;
		  const double C0 = 9.18938533204672742e-01;
		  const double C1 = 8.33333333333333333e-02;
		  const double C3 = -2.77777777777777778e-03;
		  const double C5 = 7.93650793650793651e-04;
		  const double C7 = -5.95238095238095238e-04;
	  ...
	  /// <returns> result </returns>
	  /// <exception cref="IllegalArgumentException"> error </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static long longFactorial(int k) throws IllegalArgumentException
	  ...
	  {
		const double C1 = 8.33333333333333333e-02; //  +1/12
		const double C3 = -2.77777777777777778e-03; //  -1/360
		const double C5 = 7.93650793650793651e-04; //  +1/1260
		const double C7 = -5.95238095238095238e-04; //  -1/1680
		...
		{
		  return stirlingCorrection_Renamed[k];
		}
	  }
