...
namespace com.opengamma.strata.math.impl.statistics.descriptive
{
	...
	/// </para>
	/// </summary>
	public sealed class NearestIndexQuantileMethod : DiscreteQuantileMethod
	{

	  /// <summary>
	  /// Default implementation. </summary>
	  public static readonly NearestIndexQuantileMethod DEFAULT = new NearestIndexQuantileMethod();
