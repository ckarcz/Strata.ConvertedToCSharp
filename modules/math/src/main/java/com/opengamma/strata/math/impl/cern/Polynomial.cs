...
namespace com.opengamma.strata.math.impl.cern
{
	...
	/// </summary>
	internal class Polynomial : Constants
	{
	  /// <summary>
...
//ORIGINAL LINE: public static double p1evl(double x, double coef[], int N) throws ArithmeticException
	  ...
	  /// <exception cref="ArithmeticException"> error </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static double polevl(double x, double coef[], int N) throws ArithmeticException
