...
namespace com.opengamma.strata.math.impl.integration
{
	...
	/// \end{align*}
	/// $$
	/// The weights and abscissas are generated by <seealso cref="GaussLegendreWeightAndAbscissaFunction"/>.
	/// <para>
	/// The function to integrate is scaled in such a way as to allow any values for the limits of the integrals.
	/// </para>
	/// </summary>
	public class GaussLegendreQuadratureIntegrator1D : GaussianQuadratureIntegrator1D
	{

	  private static readonly double?[] LIMITS = new double?[] {-1.0, 1.0};
	  private static readonly GaussLegendreWeightAndAbscissaFunction GENERATOR = new GaussLegendreWeightAndAbscissaFunction();

	  /// <param name="n"> The number of sample points to be used in the integration, not negative or zero </param>
	  public GaussLegendreQuadratureIntegrator1D(int n) : base(n, GENERATOR)
	  {
	  }
