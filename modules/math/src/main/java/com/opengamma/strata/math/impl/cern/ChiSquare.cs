...
namespace com.opengamma.strata.math.impl.cern
{
	...
	/// </para>
	/// <para>J.F. Monahan (1987): An algorithm for generating chi random variables, ACM Trans. Math. Software 13, 168-172.
	/// 
	...
	public class ChiSquare : AbstractContinousDistribution
	{
	  ...
	  protected internal static ChiSquare shared = new ChiSquare(1.0, makeDefaultGenerator());
	  ...
	  /// <exception cref="IllegalArgumentException"> if <tt>freedom &lt; 1.0</tt>. </exception>
	  ...
	  /// <param name="freedom"> degrees of freedom.
	  /// It should hold <tt>freedom &lt; 1.0</tt>. </param>
	  /// <returns> result </returns>
	  public virtual double nextDouble(double freedom)
	  {
		/// <summary>
		///****************************************************************
		///                                                                *
