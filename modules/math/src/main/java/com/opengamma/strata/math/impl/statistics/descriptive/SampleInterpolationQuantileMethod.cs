...
namespace com.opengamma.strata.math.impl.statistics.descriptive
{
	...
	/// </para>
	/// </summary>
	public sealed class SampleInterpolationQuantileMethod : InterpolationQuantileMethod
	{

	  /// <summary>
	  /// Default implementation. </summary>
	  public static readonly SampleInterpolationQuantileMethod DEFAULT = new SampleInterpolationQuantileMethod();
