...
namespace com.opengamma.strata.math.impl.minimization
{
	...
	/// 
	public class ParabolicMinimumBracketer : MinimumBracketer
	{

	  private const double ZERO = 1e-20;
	  private const int MAX_ITER = 100;
	  private const int MAX_MAGNIFICATION = 100;
	  private static readonly double MAGNIFICATION = 1 + GOLDEN;

	  public override double[] getBracketedPoints(System.Func<double, double> f, double xLower, double xUpper)
	  {
