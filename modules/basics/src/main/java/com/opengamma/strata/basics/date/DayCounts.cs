...
namespace com.opengamma.strata.basics.date
{
	...
	public sealed class DayCounts
	{
	  ...
	  /// </summary>
	  internal static readonly ExtendedEnum<DayCount> ENUM_LOOKUP = ExtendedEnum.of(typeof(DayCount));
	  ...
	  /// </para>
	  /// </summary>
	  internal static readonly DayCount_ScheduleInfo SIMPLE_SCHEDULE_INFO = new DayCount_ScheduleInfoAnonymousInnerClass();

	  private class DayCount_ScheduleInfoAnonymousInnerClass : DayCount_ScheduleInfo
	  {
		  public DayCount_ScheduleInfoAnonymousInnerClass()
		  {
		  }
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ONE_ONE = DayCount.of(StandardDayCounts.ONE_ONE.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_ACT_ISDA = DayCount.of(StandardDayCounts.ACT_ACT_ISDA.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// <para>
	  /// The method <seealso cref="DayCount#yearFraction(LocalDate, LocalDate)"/> will throw an
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_ACT_ICMA = DayCount.of(StandardDayCounts.ACT_ACT_ICMA.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_ACT_AFB = DayCount.of(StandardDayCounts.ACT_ACT_AFB.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_ACT_YEAR = DayCount.of(StandardDayCounts.ACT_ACT_YEAR.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_365_ACTUAL = DayCount.of(StandardDayCounts.ACT_365_ACTUAL.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_365L = DayCount.of(StandardDayCounts.ACT_365L.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_360 = DayCount.of(StandardDayCounts.ACT_360.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_364 = DayCount.of(StandardDayCounts.ACT_364.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_365F = DayCount.of(StandardDayCounts.ACT_365F.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount ACT_365_25 = DayCount.of(StandardDayCounts.ACT_365_25.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount NL_365 = DayCount.of(StandardDayCounts.NL_365.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_360_ISDA = DayCount.of(StandardDayCounts.THIRTY_360_ISDA.Name);
	  /// <summary>
	  ...
	  /// The EOM rule is set in the <seealso cref="ScheduleInfo"/>. The default value for EOM is true,
	  /// as used by <seealso cref="DayCount#yearFraction(LocalDate, LocalDate)"/>.
	  /// </para>
	  /// <para>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_U_360 = DayCount.of(StandardDayCounts.THIRTY_U_360.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// <para>
	  /// This day count is not dependent on the EOM flag in <seealso cref="ScheduleInfo"/>.
	  /// </para>
	  /// <para>
	  ...
	  /// </para>
	  /// <para>
	  /// The method <seealso cref="DayCount#yearFraction(LocalDate, LocalDate)"/> will assume
	  /// that the end-of-month rule applies.
	  /// 
	  /// </para>
	  /// </summary>
	  /// <seealso cref= #THIRTY_U_360 </seealso>
	  public static readonly DayCount THIRTY_U_360_EOM = DayCount.of(StandardDayCounts.THIRTY_U_360_EOM.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_360_PSA = DayCount.of(StandardDayCounts.THIRTY_360_PSA.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_E_360_ISDA = DayCount.of(StandardDayCounts.THIRTY_E_360_ISDA.Name);
	  /// <summary>
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_E_360 = DayCount.of(StandardDayCounts.THIRTY_E_360.Name);
	  /// <summary>
	  /// The '30E+/360' day count, which treats input day-of-month 31 specially.
	  /// <para>
	  /// The result is calculated as {@code (360 * deltaYear + 30 * deltaMonth + deltaDay) / 360}.
	  ...
	  /// </para>
	  /// </summary>
	  public static readonly DayCount THIRTY_EPLUS_360 = DayCount.of(StandardDayCounts.THIRTY_EPLUS_360.Name);
