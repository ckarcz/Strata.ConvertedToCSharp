...
//	import static org.assertj.core.data.Offset.offset;
	...
	/// <summary>
	/// Test <seealso cref="MultiCurrencyAmountArray"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class MultiCurrencyAmountArrayTest
	public class MultiCurrencyAmountArrayTest
	{

	  private static readonly MultiCurrencyAmountArray VALUES_ARRAY = MultiCurrencyAmountArray.of(ImmutableList.of(MultiCurrencyAmount.of(CurrencyAmount.of(Currency.GBP, 20), CurrencyAmount.of(Currency.USD, 30), CurrencyAmount.of(Currency.EUR, 40)), MultiCurrencyAmount.of(CurrencyAmount.of(Currency.GBP, 21), CurrencyAmount.of(Currency.USD, 32), CurrencyAmount.of(Currency.EUR, 43)), MultiCurrencyAmount.of(CurrencyAmount.of(Currency.GBP, 22), CurrencyAmount.of(Currency.USD, 33), CurrencyAmount.of(Currency.EUR, 44))));
...
//ORIGINAL LINE: public void serializeSize() throws Exception
	  ...
	  public virtual void test_getValues()
	  {
		...
		assertThat(VALUES_ARRAY.Values).isEqualTo(expected);
	  }
