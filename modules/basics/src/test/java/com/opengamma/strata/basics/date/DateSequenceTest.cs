...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="DateSequence"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class DateSequenceTest
	public class DateSequenceTest
	{
	  ...
	  //-------------------------------------------------------------------------
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DataProvider(name = "quarterlyImm") public static Object[][] data_quarterlyImm()
	  public static object[][] data_quarterlyImm()
	  {
		return new object[][]
		{
			new object[] {date(2013, 1, 1), date(2013, 3, 20), date(2013, 6, 19), date(2013, 9, 18)},
			new object[] {date(2013, 3, 20), date(2013, 6, 19), date(2013, 9, 18), date(2013, 12, 18)},
			new object[] {date(2013, 6, 19), date(2013, 9, 18), date(2013, 12, 18), date(2014, 3, 19)},
			new object[] {date(2013, 9, 18), date(2013, 12, 18), date(2014, 3, 19), date(2014, 6, 18)},
			new object[] {date(2013, 12, 18), date(2014, 3, 19), date(2014, 6, 18), date(2014, 9, 17)}
		};
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(dataProvider = "quarterlyImm") public void test_nextQuarterlyImm(java.time.LocalDate super, java.time.LocalDate immDate1, java.time.LocalDate immDate2, java.time.LocalDate immDate3)
	  public virtual void test_nextQuarterlyImm(LocalDate @base, LocalDate immDate1, LocalDate immDate2, LocalDate immDate3)
	  {
		LocalDate date = @base;
		while (!date.isAfter(immDate1))
		{
	  ...
	  //-------------------------------------------------------------------------
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DataProvider(name = "monthlyImm") public static Object[][] data_monthlyImm()
	  public static object[][] data_monthlyImm()
	  {
		return new object[][]
		{
			new object[] {date(2014, 12, 17), date(2015, 1, 21), date(2015, 2, 18), date(2015, 3, 18)},
			new object[] {date(2015, 1, 21), date(2015, 2, 18), date(2015, 3, 18), date(2015, 4, 15)},
			new object[] {date(2015, 2, 18), date(2015, 3, 18), date(2015, 4, 15), date(2015, 5, 20)}
		};
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(dataProvider = "monthlyImm") public void test_nextOrSameMonthlyImm(java.time.LocalDate super, java.time.LocalDate immDate1, java.time.LocalDate immDate2, java.time.LocalDate immDate3)
	  public virtual void test_nextOrSameMonthlyImm(LocalDate @base, LocalDate immDate1, LocalDate immDate2, LocalDate immDate3)
	  {
		LocalDate date = @base.plusDays(1);
		while (!date.isAfter(immDate1))
		{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(dataProvider = "monthlyImm") public void test_nextMonthlyImm(java.time.LocalDate super, java.time.LocalDate immDate1, java.time.LocalDate immDate2, java.time.LocalDate immDate3)
	  public virtual void test_nextMonthlyImm(LocalDate @base, LocalDate immDate1, LocalDate immDate2, LocalDate immDate3)
	  {
		LocalDate date = @base;
		while (!date.isAfter(immDate1))
		{
	  ...
	  //-------------------------------------------------------------------------
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @DataProvider(name = "quarterly10th") public static Object[][] data_quarterly10th()
	  public static object[][] data_quarterly10th()
	  {
		return new object[][]
		{
			new object[] {date(2013, 1, 1), date(2013, 3, 10), date(2013, 6, 10), date(2013, 9, 10)},
			new object[] {date(2013, 3, 20), date(2013, 6, 10), date(2013, 9, 10), date(2013, 12, 10)},
			new object[] {date(2013, 6, 19), date(2013, 9, 10), date(2013, 12, 10), date(2014, 3, 10)},
			new object[] {date(2013, 9, 18), date(2013, 12, 10), date(2014, 3, 10), date(2014, 6, 10)},
			new object[] {date(2013, 12, 18), date(2014, 3, 10), date(2014, 6, 10), date(2014, 9, 10)}
		};
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(dataProvider = "quarterly10th") public void test_nextQuarterly10th(java.time.LocalDate super, java.time.LocalDate expect1, java.time.LocalDate expect2, java.time.LocalDate expect3)
	  public virtual void test_nextQuarterly10th(LocalDate @base, LocalDate expect1, LocalDate expect2, LocalDate expect3)
	  {
		LocalDate date = @base;
		while (!date.isAfter(expect1))
		{
	  ...
	  //-------------------------------------------------------------------------
	  public virtual void test_dummy()
	  {
	  ...
	  {
		coverPrivateConstructor(typeof(DateSequences));
		coverEnum(typeof(StandardDateSequences));
	  }
	  ...
	  {
		assertJodaConvert(typeof(DateSequence), DateSequences.QUARTERLY_IMM);
		assertJodaConvert(typeof(DateSequence), DateSequences.MONTHLY_IMM);
	  }

	  //-------------------------------------------------------------------------
	  internal class DummyDateSequence : DateSequence
	  {
		...
		public virtual LocalDate dateMatching(YearMonth yearMonth)
		{
		  return date(2015, 10, 29);
		}
