...
namespace com.opengamma.strata.loader.impl.fpml
{
	...
	/// </para>
	/// </summary>
	internal sealed class SwapFpmlParserPlugin : FpmlParserPlugin
	{
	  ...
	  /// </summary>
	  public static readonly SwapFpmlParserPlugin INSTANCE = new SwapFpmlParserPlugin();
	  ...
	  private PaymentRelativeTo parsePayRelativeTo(XmlElement baseEl)
	  {
		...
		{
		  throw new FpmlParseException(Messages.format("Unknown 'payRelativeTo' value '{}', expected 'CalculationPeriodStartDate' or 'CalculationPeriodEndDate'", str));
		}
	  }
	  ...
	  private NegativeRateMethod parseNegativeInterestRateTreatment(XmlElement baseEl)
	  {
		...
		{
		  throw new FpmlParseException(Messages.format("Unknown 'negativeInterestRateTreatment' value '{}', " + "expected 'NegativeInterestRateMethod' or 'ZeroInterestRateMethod'", str));
		}
	  }
	  ...
	  private IborRateResetMethod parseAveragingMethod(XmlElement baseEl)
	  {
		...
		{
		  throw new FpmlParseException(Messages.format("Unknown 'resetMethod' value '{}', expected 'Unweighted' or 'Weighted'", str));
		}
	  }
	  ...
	  private FixingRelativeTo parseResetRelativeTo(XmlElement baseEl)
	  {
		...
		{
		  throw new FpmlParseException(Messages.format("Unknown 'resetRelativeTo' value '{}', expected 'CalculationPeriodStartDate' or 'CalculationPeriodEndDate'", str));
		}
	  }
