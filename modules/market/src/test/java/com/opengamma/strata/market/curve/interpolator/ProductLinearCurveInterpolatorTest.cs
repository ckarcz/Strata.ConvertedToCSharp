...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="ProductLinearCurveInterpolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class ProductLinearCurveInterpolatorTest
	public class ProductLinearCurveInterpolatorTest
	{

	  private static readonly CurveInterpolator INTERP = ProductLinearCurveInterpolator.INSTANCE;
	  private static readonly CurveInterpolator BASE_INTERP = LinearCurveInterpolator.INSTANCE;
	...
	return x.Value >= xValues.get(0) && x.Value <= xValues.get(nData - 1);
	  ...
	  {
		assertEquals(INTERP.Name, ProductLinearCurveInterpolator.NAME);
