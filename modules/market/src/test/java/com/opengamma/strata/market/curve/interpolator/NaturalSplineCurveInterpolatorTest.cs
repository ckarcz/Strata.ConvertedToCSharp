...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NaturalSplineCurveInterpolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NaturalSplineCurveInterpolatorTest
	public class NaturalSplineCurveInterpolatorTest
	{

	  private static readonly CurveInterpolator NATURAL_SPLINE_INTERPOLATOR = NaturalSplineCurveInterpolator.INSTANCE;
	  ...
	  {
		assertEquals(NATURAL_SPLINE_INTERPOLATOR.Name, NaturalSplineCurveInterpolator.NAME);
