...
//	import static org.testng.Assert.assertTrue;
	...
	/// <summary>
	/// Test <seealso cref="DiscountFactorQuadraticLeftZeroRateCurveExtrapolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class DiscountFactorQuadraticLeftZeroRateCurveExtrapolatorTest
	public class DiscountFactorQuadraticLeftZeroRateCurveExtrapolatorTest
	{
	  ...
	  {
		assertEquals(DISCOUNT_FACTOR_QUADRATIC_LEFT_ZERO_RATE.Name, DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.NAME);
		assertEquals(DISCOUNT_FACTOR_QUADRATIC_LEFT_ZERO_RATE.ToString(), DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.NAME);
	  }
