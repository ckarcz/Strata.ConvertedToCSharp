...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="SquareLinearCurveInterpolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class SquareLinearCurveInterpolatorTest
	public class SquareLinearCurveInterpolatorTest
	{

	  private static readonly CurveInterpolator SQUARE_LINEAR_INTERPOLATOR = SquareLinearCurveInterpolator.INSTANCE;
	  ...
	  private static readonly DoubleArray Y_TEST = DoubleArray.of(3.5355339059327378, 2.98475292109749, 5.1478150704934995);
	  private const double TOL = 1.e-12;

	  public virtual void test_basics()
	  {
		assertEquals(SQUARE_LINEAR_INTERPOLATOR.Name, SquareLinearCurveInterpolator.NAME);
