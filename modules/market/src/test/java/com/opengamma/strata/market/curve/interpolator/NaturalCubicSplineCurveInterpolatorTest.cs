...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="NaturalCubicSplineCurveInterpolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class NaturalCubicSplineCurveInterpolatorTest
	public class NaturalCubicSplineCurveInterpolatorTest
	{

	  private static readonly CurveInterpolator NATURAL_CUBLIC_SPLINE_INTERPOLATOR = NaturalCubicSplineCurveInterpolator.INSTANCE;
	  ...
	  {
		assertEquals(NATURAL_CUBLIC_SPLINE_INTERPOLATOR.Name, NaturalCubicSplineCurveInterpolator.NAME);
