...
//	import static org.testng.Assert.assertEquals;
	...
	/// <summary>
	/// Test <seealso cref="LogNaturalSplineDiscountFactorCurveInterpolator"/>.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public class LogNaturalSplineDiscountFactorCurveInterpolatorTest
	public class LogNaturalSplineDiscountFactorCurveInterpolatorTest
	{

	  private static readonly CurveInterpolator LNDFC_INTERPOLATOR = LogNaturalSplineDiscountFactorCurveInterpolator.INSTANCE;
	  private static readonly CurveExtrapolator FLAT_EXTRAPOLATOR = CurveExtrapolators.FLAT;

	  private static readonly DoubleArray X_DATA = DoubleArray.of(0.2, 0.4, 1.0, 1.8, 2.8, 5.0);
	  ...
	  private static readonly DoubleArray Y_TEST = DoubleArray.of(3.1, 2.375168445874886, 1.9885112466306356);

	  private const double TOL = 1.e-12;

	  public virtual void test_basics()
	  {
		assertEquals(LNDFC_INTERPOLATOR.Name, LogNaturalSplineDiscountFactorCurveInterpolator.NAME);
