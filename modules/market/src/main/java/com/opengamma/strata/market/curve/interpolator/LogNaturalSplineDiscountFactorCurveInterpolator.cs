...
namespace com.opengamma.strata.market.curve.interpolator
{
	...
	using ClampedPiecewisePolynomialInterpolator = com.opengamma.strata.math.impl.interpolation.ClampedPiecewisePolynomialInterpolator;
	...
	/// </para>
	/// <para>
	/// The natural cubic spline is determined by <seealso cref="LogNaturalSplineHelper"/>, where the tridiagonal
	/// algorithm is used to solve a linear system.
	/// </para>
	/// </summary>
	[Serializable]
	internal sealed class LogNaturalSplineDiscountFactorCurveInterpolator : CurveInterpolator
	{

	  /// <summary>
	  /// The interpolator name.
	  /// </summary>
	  public const string NAME = "LogNaturalSplineDiscountFactor";
	  /// <summary>
	  /// The interpolator instance.
	  /// </summary>
	  public static readonly CurveInterpolator INSTANCE = new LogNaturalSplineDiscountFactorCurveInterpolator();
