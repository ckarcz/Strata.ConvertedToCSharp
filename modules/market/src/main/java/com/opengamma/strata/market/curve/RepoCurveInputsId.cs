...
//ORIGINAL LINE: @BeanDefinition(style = "light", cacheHashCode = true) public final class RepoCurveInputsId implements com.opengamma.strata.data.MarketDataId<RatesCurveInputs>, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class RepoCurveInputsId : MarketDataId<RatesCurveInputs>, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.data.ObservableSource observableSource;
	...
	//-------------------------------------------------------------------------
	  ...
	  public static RepoCurveInputsId of(CurveGroupName groupName, CurveName curveName, ObservableSource obsSource)
	  {

		return new RepoCurveInputsId(groupName, curveName, obsSource);
	  }
	...
	//-------------------------------------------------------------------------
	  ...
	  {
		return (new StringBuilder(32)).Append("RepoCurveInputsId:").Append(curveGroupName).Append('/').Append(curveName).Append(observableSource.Equals(ObservableSource.NONE) ? "" : "/" + observableSource).ToString();
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code RepoCurveInputsId}.
	  /// </summary>
	  private static readonly TypedMetaBean<RepoCurveInputsId> META_BEAN = LightMetaBean.of(typeof(RepoCurveInputsId), MethodHandles.lookup(), new string[] {"curveGroupName", "curveName", "observableSource"}, new object[0]);

	  /// <summary>
	  /// The meta-bean for {@code RepoCurveInputsId}. </summary>
	  /// <returns> the meta-bean, not null </returns>
	  public static TypedMetaBean<RepoCurveInputsId> meta()
	  {
		return META_BEAN;
	  }
	  ...
	  private RepoCurveInputsId(CurveGroupName curveGroupName, CurveName curveName, ObservableSource observableSource)
	  {
	  ...
	  public override TypedMetaBean<RepoCurveInputsId> metaBean()
	  {
		return META_BEAN;
	  }
	  ...
	  public override bool Equals(object obj)
	  {
		...
		{
		  RepoCurveInputsId other = (RepoCurveInputsId) obj;
