...
namespace com.opengamma.strata.market.curve.interpolator
{
	...
	/// </para>
	/// <para>
	/// See <seealso cref="NaturalSplineInterpolator"/> for the detail on the underlying interpolator.
	/// </para>
	/// </summary>
	[Serializable]
	internal sealed class ProductNaturalSplineCurveInterpolator : CurveInterpolator
	{

	  /// <summary>
	  /// The interpolator name.
	  /// </summary>
	  public const string NAME = "ProductNaturalSpline";
	  /// <summary>
	  /// The interpolator instance.
	  /// </summary>
	  public static readonly CurveInterpolator INSTANCE = new ProductNaturalSplineCurveInterpolator();
