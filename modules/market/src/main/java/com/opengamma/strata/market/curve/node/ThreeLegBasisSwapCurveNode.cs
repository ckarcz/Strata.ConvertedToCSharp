...
//ORIGINAL LINE: @BeanDefinition public final class ThreeLegBasisSwapCurveNode implements com.opengamma.strata.market.curve.CurveNode, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class ThreeLegBasisSwapCurveNode : CurveNode, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.product.swap.type.ThreeLegBasisSwapTemplate template;
		private readonly ThreeLegBasisSwapTemplate template;
	  /// <summary>
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code ThreeLegBasisSwapCurveNode}. </summary>
	  ...
	  {
		MetaBean.register(ThreeLegBasisSwapCurveNode.Meta.INSTANCE);
	  }
	  ...
	  public override ThreeLegBasisSwapCurveNode.Meta metaBean()
	  {
		return ThreeLegBasisSwapCurveNode.Meta.INSTANCE;
	  }
	  ...
	  public ThreeLegBasisSwapTemplate Template
	  {
		  get
		  {
			return template;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  template_Renamed = DirectMetaProperty.ofImmutable(this, "template", typeof(ThreeLegBasisSwapCurveNode), typeof(ThreeLegBasisSwapTemplate));
			  rateId_Renamed = DirectMetaProperty.ofImmutable(this, "rateId", typeof(ThreeLegBasisSwapCurveNode), typeof(ObservableId));
			  additionalSpread_Renamed = DirectMetaProperty.ofImmutable(this, "additionalSpread", typeof(ThreeLegBasisSwapCurveNode), Double.TYPE);
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(ThreeLegBasisSwapCurveNode), typeof(string));
			  date_Renamed = DirectMetaProperty.ofImmutable(this, "date", typeof(ThreeLegBasisSwapCurveNode), typeof(CurveNodeDate));
			  dateOrder_Renamed = DirectMetaProperty.ofImmutable(this, "dateOrder", typeof(ThreeLegBasisSwapCurveNode), typeof(CurveNodeDateOrder));
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<ThreeLegBasisSwapTemplate> template_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override ThreeLegBasisSwapCurveNode.Builder builder()
		{
		  return new ThreeLegBasisSwapCurveNode.Builder();
		}
		...
		{
		  return typeof(ThreeLegBasisSwapCurveNode);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -1321546630: // template
			  return ((ThreeLegBasisSwapCurveNode) bean).Template;
			case -938107365: // rateId
			  return ((ThreeLegBasisSwapCurveNode) bean).RateId;
			case 291232890: // additionalSpread
			  return ((ThreeLegBasisSwapCurveNode) bean).AdditionalSpread;
			case 102727412: // label
			  return ((ThreeLegBasisSwapCurveNode) bean).Label;
			case 3076014: // date
			  return ((ThreeLegBasisSwapCurveNode) bean).Date;
			case -263699392: // dateOrder
			  return ((ThreeLegBasisSwapCurveNode) bean).DateOrder;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<ThreeLegBasisSwapCurveNode>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal ThreeLegBasisSwapTemplate template_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override ThreeLegBasisSwapCurveNode build()
		{
		  preBuild(this);
		  return new ThreeLegBasisSwapCurveNode(template_Renamed, rateId_Renamed, additionalSpread_Renamed, label_Renamed, date_Renamed, dateOrder_Renamed);
		}
