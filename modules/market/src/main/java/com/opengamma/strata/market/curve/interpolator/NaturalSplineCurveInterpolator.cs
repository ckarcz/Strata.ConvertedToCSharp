...
namespace com.opengamma.strata.market.curve.interpolator
{
	...
	/// </summary>
	[Serializable]
	internal sealed class NaturalSplineCurveInterpolator : CurveInterpolator
	{

	  /// <summary>
	  /// The interpolator name.
	  /// </summary>
	  public const string NAME = "NaturalSpline";
	  /// <summary>
	  /// The interpolator instance.
	  /// </summary>
	  public static readonly CurveInterpolator INSTANCE = new NaturalSplineCurveInterpolator();
