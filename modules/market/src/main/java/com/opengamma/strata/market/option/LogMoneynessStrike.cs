...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class LogMoneynessStrike implements Strike, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class LogMoneynessStrike : Strike, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(overrideGet = true) private final double value;
	  ...
	  /// </summary>
	  /// <param name="logMoneyness">  the value of log-moneyness </param>
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code LogMoneynessStrike}. </summary>
	  ...
	  {
		MetaBean.register(LogMoneynessStrike.Meta.INSTANCE);
	  }
	  ...
	  private LogMoneynessStrike(double value)
	  {
		this.value = value;
	  }

	  public override LogMoneynessStrike.Meta metaBean()
	  {
		return LogMoneynessStrike.Meta.INSTANCE;
	  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// Gets the value of log-moneyness. </summary>
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  value_Renamed = DirectMetaProperty.ofImmutable(this, "value", typeof(LogMoneynessStrike), Double.TYPE);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends LogMoneynessStrike> builder()
		public override BeanBuilder<LogMoneynessStrike> builder()
		{
		...
		{
		  return typeof(LogMoneynessStrike);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 111972721: // value
			  return ((LogMoneynessStrike) bean).Value;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<LogMoneynessStrike>
	  {
		...
		public override LogMoneynessStrike build()
		{
		  return new LogMoneynessStrike(value);
		}
