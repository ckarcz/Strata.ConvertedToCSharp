...
//ORIGINAL LINE: @BeanDefinition public final class OvernightIborSwapCurveNode implements com.opengamma.strata.market.curve.CurveNode, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class OvernightIborSwapCurveNode : CurveNode, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.product.swap.type.OvernightIborSwapTemplate template;
		private readonly OvernightIborSwapTemplate template;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.market.curve.CurveNodeDateOrder dateOrder;
	  ...
	  /// <param name="additionalSpread">  the additional spread amount added to the spread </param>
	  /// <returns> a node whose instrument is built from the template using a market rate </returns>
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  {
		return new OvernightIborSwapCurveNode(template, rateId, additionalSpread, label, date, dateOrder);
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code OvernightIborSwapCurveNode}. </summary>
	  ...
	  {
		MetaBean.register(OvernightIborSwapCurveNode.Meta.INSTANCE);
	  }
	  ...
	  public override OvernightIborSwapCurveNode.Meta metaBean()
	  {
		return OvernightIborSwapCurveNode.Meta.INSTANCE;
	  }
	  ...
	  public OvernightIborSwapTemplate Template
	  {
		  get
		  {
			return template;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  template_Renamed = DirectMetaProperty.ofImmutable(this, "template", typeof(OvernightIborSwapCurveNode), typeof(OvernightIborSwapTemplate));
			  rateId_Renamed = DirectMetaProperty.ofImmutable(this, "rateId", typeof(OvernightIborSwapCurveNode), typeof(ObservableId));
			  additionalSpread_Renamed = DirectMetaProperty.ofImmutable(this, "additionalSpread", typeof(OvernightIborSwapCurveNode), Double.TYPE);
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(OvernightIborSwapCurveNode), typeof(string));
			  date_Renamed = DirectMetaProperty.ofImmutable(this, "date", typeof(OvernightIborSwapCurveNode), typeof(CurveNodeDate));
			  dateOrder_Renamed = DirectMetaProperty.ofImmutable(this, "dateOrder", typeof(OvernightIborSwapCurveNode), typeof(CurveNodeDateOrder));
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<OvernightIborSwapTemplate> template_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override OvernightIborSwapCurveNode.Builder builder()
		{
		  return new OvernightIborSwapCurveNode.Builder();
		}
		...
		{
		  return typeof(OvernightIborSwapCurveNode);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -1321546630: // template
			  return ((OvernightIborSwapCurveNode) bean).Template;
			case -938107365: // rateId
			  return ((OvernightIborSwapCurveNode) bean).RateId;
			case 291232890: // additionalSpread
			  return ((OvernightIborSwapCurveNode) bean).AdditionalSpread;
			case 102727412: // label
			  return ((OvernightIborSwapCurveNode) bean).Label;
			case 3076014: // date
			  return ((OvernightIborSwapCurveNode) bean).Date;
			case -263699392: // dateOrder
			  return ((OvernightIborSwapCurveNode) bean).DateOrder;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<OvernightIborSwapCurveNode>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal OvernightIborSwapTemplate template_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(OvernightIborSwapCurveNode beanToCopy)
		{
		...
		public override Builder set(string propertyName, object newValue)
		{
		  ...
		  {
			case -1321546630: // template
			  this.template_Renamed = (OvernightIborSwapTemplate) newValue;
			  break;
			case -938107365: // rateId
		...
		public override OvernightIborSwapCurveNode build()
		{
		  preBuild(this);
		  return new OvernightIborSwapCurveNode(template_Renamed, rateId_Renamed, additionalSpread_Renamed, label_Renamed, date_Renamed, dateOrder_Renamed);
		}
