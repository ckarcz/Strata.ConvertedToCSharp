...
//ORIGINAL LINE: @BeanDefinition public final class IborIborSwapCurveNode implements com.opengamma.strata.market.curve.CurveNode, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class IborIborSwapCurveNode : CurveNode, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.product.swap.type.IborIborSwapTemplate template;
		private readonly IborIborSwapTemplate template;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.market.curve.CurveNodeDateOrder dateOrder;
	  ...
	  /// <returns> a node whose instrument is built from the template using a market rate </returns>
	  public static IborIborSwapCurveNode of(IborIborSwapTemplate template, ObservableId rateId, double additionalSpread, string label)
	  {

		return new IborIborSwapCurveNode(template, rateId, additionalSpread, label, CurveNodeDate.END, CurveNodeDateOrder.DEFAULT);
	  }
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  {
		return new IborIborSwapCurveNode(template, rateId, additionalSpread, label, date, dateOrder);
	  }

	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code IborIborSwapCurveNode}. </summary>
	  ...
	  {
		MetaBean.register(IborIborSwapCurveNode.Meta.INSTANCE);
	  }
	  ...
	  private IborIborSwapCurveNode(IborIborSwapTemplate template, ObservableId rateId, double additionalSpread, string label, CurveNodeDate date, CurveNodeDateOrder dateOrder)
	  {
	  ...
	  public override IborIborSwapCurveNode.Meta metaBean()
	  {
		return IborIborSwapCurveNode.Meta.INSTANCE;
	  }
	  ...
	  public IborIborSwapTemplate Template
	  {
		  get
		  {
			return template;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  template_Renamed = DirectMetaProperty.ofImmutable(this, "template", typeof(IborIborSwapCurveNode), typeof(IborIborSwapTemplate));
			  rateId_Renamed = DirectMetaProperty.ofImmutable(this, "rateId", typeof(IborIborSwapCurveNode), typeof(ObservableId));
			  additionalSpread_Renamed = DirectMetaProperty.ofImmutable(this, "additionalSpread", typeof(IborIborSwapCurveNode), Double.TYPE);
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(IborIborSwapCurveNode), typeof(string));
			  date_Renamed = DirectMetaProperty.ofImmutable(this, "date", typeof(IborIborSwapCurveNode), typeof(CurveNodeDate));
			  dateOrder_Renamed = DirectMetaProperty.ofImmutable(this, "dateOrder", typeof(IborIborSwapCurveNode), typeof(CurveNodeDateOrder));
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<IborIborSwapTemplate> template_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override IborIborSwapCurveNode.Builder builder()
		{
		  return new IborIborSwapCurveNode.Builder();
		}
		...
		{
		  return typeof(IborIborSwapCurveNode);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -1321546630: // template
			  return ((IborIborSwapCurveNode) bean).Template;
			case -938107365: // rateId
			  return ((IborIborSwapCurveNode) bean).RateId;
			case 291232890: // additionalSpread
			  return ((IborIborSwapCurveNode) bean).AdditionalSpread;
			case 102727412: // label
			  return ((IborIborSwapCurveNode) bean).Label;
			case 3076014: // date
			  return ((IborIborSwapCurveNode) bean).Date;
			case -263699392: // dateOrder
			  return ((IborIborSwapCurveNode) bean).DateOrder;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<IborIborSwapCurveNode>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal IborIborSwapTemplate template_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(IborIborSwapCurveNode beanToCopy)
		{
		...
		public override Builder set(string propertyName, object newValue)
		{
		  ...
		  {
			case -1321546630: // template
			  this.template_Renamed = (IborIborSwapTemplate) newValue;
			  break;
			case -938107365: // rateId
		...
		public override IborIborSwapCurveNode build()
		{
		  preBuild(this);
		  return new IborIborSwapCurveNode(template_Renamed, rateId_Renamed, additionalSpread_Renamed, label_Renamed, date_Renamed, dateOrder_Renamed);
		}
