...
//ORIGINAL LINE: @BeanDefinition public final class TermDepositCurveNode implements com.opengamma.strata.market.curve.CurveNode, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class TermDepositCurveNode : CurveNode, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.product.deposit.type.TermDepositTemplate template;
		private readonly TermDepositTemplate template;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.market.curve.CurveNodeDateOrder dateOrder;
	  ...
	  /// <returns> a node whose instrument is built from the template using a market rate </returns>
	  public static TermDepositCurveNode of(TermDepositTemplate template, ObservableId rateId, double additionalSpread, string label)
	  {

		return new TermDepositCurveNode(template, rateId, additionalSpread, label, CurveNodeDate.END, CurveNodeDateOrder.DEFAULT);
	  }
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  {
		throw new System.NotSupportedException("Node date of 'LastFixing' is not supported for TermDeposit");
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code TermDepositCurveNode}. </summary>
	  ...
	  {
		MetaBean.register(TermDepositCurveNode.Meta.INSTANCE);
	  }
	  ...
	  private TermDepositCurveNode(TermDepositTemplate template, ObservableId rateId, double additionalSpread, string label, CurveNodeDate date, CurveNodeDateOrder dateOrder)
	  {
	  ...
	  public override TermDepositCurveNode.Meta metaBean()
	  {
		return TermDepositCurveNode.Meta.INSTANCE;
	  }
	  ...
	  //-----------------------------------------------------------------------
	  /// <summary>
	  /// Gets the template for the term deposit associated with this node. </summary>
	  /// <returns> the value of the property, not null </returns>
	  public TermDepositTemplate Template
	  {
		  get
		  {
			return template;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  template_Renamed = DirectMetaProperty.ofImmutable(this, "template", typeof(TermDepositCurveNode), typeof(TermDepositTemplate));
			  rateId_Renamed = DirectMetaProperty.ofImmutable(this, "rateId", typeof(TermDepositCurveNode), typeof(ObservableId));
			  additionalSpread_Renamed = DirectMetaProperty.ofImmutable(this, "additionalSpread", typeof(TermDepositCurveNode), Double.TYPE);
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(TermDepositCurveNode), typeof(string));
			  date_Renamed = DirectMetaProperty.ofImmutable(this, "date", typeof(TermDepositCurveNode), typeof(CurveNodeDate));
			  dateOrder_Renamed = DirectMetaProperty.ofImmutable(this, "dateOrder", typeof(TermDepositCurveNode), typeof(CurveNodeDateOrder));
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<TermDepositTemplate> template_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override TermDepositCurveNode.Builder builder()
		{
		  return new TermDepositCurveNode.Builder();
		}
		...
		{
		  return typeof(TermDepositCurveNode);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -1321546630: // template
			  return ((TermDepositCurveNode) bean).Template;
			case -938107365: // rateId
			  return ((TermDepositCurveNode) bean).RateId;
			case 291232890: // additionalSpread
			  return ((TermDepositCurveNode) bean).AdditionalSpread;
			case 102727412: // label
			  return ((TermDepositCurveNode) bean).Label;
			case 3076014: // date
			  return ((TermDepositCurveNode) bean).Date;
			case -263699392: // dateOrder
			  return ((TermDepositCurveNode) bean).DateOrder;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<TermDepositCurveNode>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal TermDepositTemplate template_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(TermDepositCurveNode beanToCopy)
		{
		...
		public override Builder set(string propertyName, object newValue)
		{
		  ...
		  {
			case -1321546630: // template
			  this.template_Renamed = (TermDepositTemplate) newValue;
			  break;
			case -938107365: // rateId
		...
		public override TermDepositCurveNode build()
		{
		  preBuild(this);
		  return new TermDepositCurveNode(template_Renamed, rateId_Renamed, additionalSpread_Renamed, label_Renamed, date_Renamed, dateOrder_Renamed);
		}

		//-----------------------------------------------------------------------
		/// <summary>
		/// Sets the template for the term deposit associated with this node. </summary>
