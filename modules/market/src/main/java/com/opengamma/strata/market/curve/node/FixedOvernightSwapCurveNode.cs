...
//ORIGINAL LINE: @BeanDefinition public final class FixedOvernightSwapCurveNode implements com.opengamma.strata.market.curve.CurveNode, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class FixedOvernightSwapCurveNode : CurveNode, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull") private final com.opengamma.strata.product.swap.type.FixedOvernightSwapTemplate template;
		private readonly FixedOvernightSwapTemplate template;
	  /// <summary>
...
//ORIGINAL LINE: @PropertyDefinition(validate = "notNull", overrideGet = true) private final com.opengamma.strata.market.curve.CurveNodeDateOrder dateOrder;
	  ...
	  /// <returns> a node whose instrument is built from the template using a market rate </returns>
	  public static FixedOvernightSwapCurveNode of(FixedOvernightSwapTemplate template, ObservableId rateId, double additionalSpread)
	  {
	  ...
	  /// <returns> a node whose instrument is built from the template using a market rate </returns>
	  public static FixedOvernightSwapCurveNode of(FixedOvernightSwapTemplate template, ObservableId rateId, double additionalSpread, string label)
	  {

		return new FixedOvernightSwapCurveNode(template, rateId, additionalSpread, label, CurveNodeDate.END, CurveNodeDateOrder.DEFAULT);
	  }
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  {
		throw new System.NotSupportedException("Node date of 'LastFixing' is not supported for FixedOvernightSwap");
	  }
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code FixedOvernightSwapCurveNode}. </summary>
	  ...
	  private FixedOvernightSwapCurveNode(FixedOvernightSwapTemplate template, ObservableId rateId, double additionalSpread, string label, CurveNodeDate date, CurveNodeDateOrder dateOrder)
	  {
	  ...
	  public override FixedOvernightSwapCurveNode.Meta metaBean()
	  {
		return FixedOvernightSwapCurveNode.Meta.INSTANCE;
	  }
	  ...
	  public FixedOvernightSwapTemplate Template
	  {
		  get
		  {
			return template;
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  template_Renamed = DirectMetaProperty.ofImmutable(this, "template", typeof(FixedOvernightSwapCurveNode), typeof(FixedOvernightSwapTemplate));
			  rateId_Renamed = DirectMetaProperty.ofImmutable(this, "rateId", typeof(FixedOvernightSwapCurveNode), typeof(ObservableId));
			  additionalSpread_Renamed = DirectMetaProperty.ofImmutable(this, "additionalSpread", typeof(FixedOvernightSwapCurveNode), Double.TYPE);
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(FixedOvernightSwapCurveNode), typeof(string));
			  date_Renamed = DirectMetaProperty.ofImmutable(this, "date", typeof(FixedOvernightSwapCurveNode), typeof(CurveNodeDate));
			  dateOrder_Renamed = DirectMetaProperty.ofImmutable(this, "dateOrder", typeof(FixedOvernightSwapCurveNode), typeof(CurveNodeDateOrder));
		...
		/// </summary>
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal MetaProperty<FixedOvernightSwapTemplate> template_Renamed;
		/// <summary>
...
//ORIGINAL LINE: @Override protected org.joda.beans.MetaProperty<?> metaPropertyGet(String propertyName)
		...
		public override FixedOvernightSwapCurveNode.Builder builder()
		{
		  return new FixedOvernightSwapCurveNode.Builder();
		}
		...
		{
		  return typeof(FixedOvernightSwapCurveNode);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case -1321546630: // template
			  return ((FixedOvernightSwapCurveNode) bean).Template;
			case -938107365: // rateId
			  return ((FixedOvernightSwapCurveNode) bean).RateId;
			case 291232890: // additionalSpread
			  return ((FixedOvernightSwapCurveNode) bean).AdditionalSpread;
			case 102727412: // label
			  return ((FixedOvernightSwapCurveNode) bean).Label;
			case 3076014: // date
			  return ((FixedOvernightSwapCurveNode) bean).Date;
			case -263699392: // dateOrder
			  return ((FixedOvernightSwapCurveNode) bean).DateOrder;
		  }
	  ...
	  /// </summary>
	  public sealed class Builder : DirectFieldsBeanBuilder<FixedOvernightSwapCurveNode>
	  {

//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal FixedOvernightSwapTemplate template_Renamed;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		internal Builder(FixedOvernightSwapCurveNode beanToCopy)
		{
		...
		public override Builder set(string propertyName, object newValue)
		{
		  ...
		  {
			case -1321546630: // template
			  this.template_Renamed = (FixedOvernightSwapTemplate) newValue;
			  break;
			case -938107365: // rateId
		...
		public override FixedOvernightSwapCurveNode build()
		{
		  preBuild(this);
		  return new FixedOvernightSwapCurveNode(template_Renamed, rateId_Renamed, additionalSpread_Renamed, label_Renamed, date_Renamed, dateOrder_Renamed);
		}
