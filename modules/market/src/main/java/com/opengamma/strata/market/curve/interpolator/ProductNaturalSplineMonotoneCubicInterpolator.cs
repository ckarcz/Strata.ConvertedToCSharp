...
namespace com.opengamma.strata.market.curve.interpolator
{
	...
	/// <summary>
	/// Product natural cubic interpolation with monotonicity filter.
	/// <para>
	/// Given a data set {@code (x[i], y[i])}, interpolate {@code (x[i], x[i] * y[i])} 
	/// by natural cubic spline with Monotonicity cubic filter.
	/// </para>
	/// <para>
	...
	/// </summary>
	[Serializable]
	internal class ProductNaturalSplineMonotoneCubicInterpolator : CurveInterpolator
	{

	  /// <summary>
	  /// The interpolator name.
	  /// </summary>
	  public const string NAME = "ProductNaturalSplineMonotoneCubic";
	  /// <summary>
	  /// The interpolator instance.
	  /// </summary>
	  public static readonly CurveInterpolator INSTANCE = new ProductNaturalSplineMonotoneCubicInterpolator();
