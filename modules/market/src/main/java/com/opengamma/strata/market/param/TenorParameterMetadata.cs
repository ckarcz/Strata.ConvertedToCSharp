...
//ORIGINAL LINE: @BeanDefinition(builderScope = "private") public final class TenorParameterMetadata implements TenoredParameterMetadata, org.joda.beans.ImmutableBean, java.io.Serializable
	[Serializable]
	public sealed class TenorParameterMetadata : TenoredParameterMetadata, ImmutableBean
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @ImmutablePreBuild private static void preBuild(Builder builder)
	  ...
	  //------------------------- AUTOGENERATED START -------------------------
	  /// <summary>
	  /// The meta-bean for {@code TenorParameterMetadata}. </summary>
	  ...
	  public override TenorParameterMetadata.Meta metaBean()
	  {
		return TenorParameterMetadata.Meta.INSTANCE;
	  }
	  ...
	  public sealed class Meta : DirectMetaBean
	  {
		  ...
		  {
			  tenor_Renamed = DirectMetaProperty.ofImmutable(this, "tenor", typeof(TenorParameterMetadata), typeof(Tenor));
			  label_Renamed = DirectMetaProperty.ofImmutable(this, "label", typeof(TenorParameterMetadata), typeof(string));
			  metaPropertyMap$ = new DirectMetaPropertyMap(this, null, "tenor", "label");
		  }
...
//ORIGINAL LINE: private final java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap$ = new org.joda.beans.impl.direct.DirectMetaPropertyMap(this, null, "tenor", "label");
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: @Override public org.joda.beans.BeanBuilder<? extends TenorParameterMetadata> builder()
		public override BeanBuilder<TenorParameterMetadata> builder()
		{
		...
		{
		  return typeof(TenorParameterMetadata);
		}
...
//ORIGINAL LINE: @Override public java.util.Map<String, org.joda.beans.MetaProperty<?>> metaPropertyMap()
		...
		protected internal override object propertyGet(Bean bean, string propertyName, bool quiet)
		{
		  ...
		  {
			case 110246592: // tenor
			  return ((TenorParameterMetadata) bean).Tenor;
			case 102727412: // label
			  return ((TenorParameterMetadata) bean).Label;
		  }
	  ...
	  /// </summary>
	  private sealed class Builder : DirectPrivateBeanBuilder<TenorParameterMetadata>
	  {
		...
		public override TenorParameterMetadata build()
		{
		  preBuild(this);
		  return new TenorParameterMetadata(tenor, label);
		}
