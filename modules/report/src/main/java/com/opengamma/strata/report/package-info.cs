...
/// <ul>
///   <li>Trade - the data is taken from the <seealso cref="com.opengamma.strata.product.Trade trade"/> or
///   <seealso cref="com.opengamma.strata.product.TradeInfo trade info"/></li>
///   <li>Security - the data is taken from the <seealso cref="com.opengamma.strata.product.Security security"/> or
///   <seealso cref="com.opengamma.strata.product.SecurityInfo security info"/></li>
///   <li>Position - the data is taken from the <seealso cref="com.opengamma.strata.product.Position position"/> or
///   <seealso cref="com.opengamma.strata.product.PositionInfo position info"/></li>
///   <li>Target - the data is taken from the <seealso cref="com.opengamma.strata.basics.CalculationTarget calculation target"/></li>
///   <li>Measure - the data is taken from the results of the calculations</li>
///   <li>Product - the data is taken from the <seealso cref="com.opengamma.strata.product.Product product"/> associated with
///   the trade. This is only applicable if the trade implements
///   <seealso cref="com.opengamma.strata.product.ProductTrade ProductTrade"/></li>
/// </ul>
...
/// <seealso cref="com.opengamma.strata.product.fra.FraTrade FraTrade"/> instances
/// the following calls will be made for each trade in the results:
/// <ul>
///   <li>{@code FraTrade.getProduct()} returning a <seealso cref="com.opengamma.strata.product.fra.Fra Fra"/></li>
///   <li>{@code Fra.getIndex()} returning an <seealso cref="com.opengamma.strata.basics.index.IborIndex IborIndex"/></li>
